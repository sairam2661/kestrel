"builtin.module"() ({
  "func.func"() <{function_type = (!torch_vtensor, !torch_vtensor) -> !torch_vtensor, sym_name = "torch_aten_cat_slice"}> ({
  ^bb0(%arg0: !torch_vtensor, %arg1: !torch_vtensor):
    ...
    %4 = "torch.aten.slice.Tensor"(%arg1, %0, %1, %2) : (!torch_vtensor, !torch_int, !torch_int, !torch_int) -> !torch_vtensor
