"builtin.module"() ({
  ...
  ^bb0(%arg0: !torch_vtensor, %arg1: !torch_vtensor):
    ...
    %5 = "torch.aten.view"(%4, %3) : (!torch_vtensor, !torch_list) -> !torch_vtensor
    %6 = "torch.aten.index_select"(%arg1, %0, %2) : (!torch_vtensor, !torch_int, !torch_int) -> !torch_vtensor
    %7 = "torch.aten.add.Tensor"(%5, %6) : (!torch_vtensor, !torch_vtensor) -> !torch_vtensor
