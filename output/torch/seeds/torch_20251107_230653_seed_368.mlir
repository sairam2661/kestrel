"builtin.module"() ({
  "func.func"() <{function_type = (!torch_vtensor, !torch_int) -> !torch_vtensor, sym_name = "fuzz_test"}> ({
  ^bb0(%arg0: !torch_vtensor, %arg1: !torch_int):
    ...
    %3 = "torch.aten._make_per_tensor_quantized_tensor"(%2, %arg1) : (!torch_vtensor, !torch_int) -> !torch_vtensor
    %4 = "torch.aten._shape_as_tensor"(%3) : (!torch_vtensor) -> !torch_vtensor
    %5 = "torch.aten.eq.Tensor"(%arg0, %3) : (!torch_vtensor, !torch_vtensor) -> !torch_vtensor
