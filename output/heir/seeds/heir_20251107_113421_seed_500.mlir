"builtin.module"() ({
  "func.func"() <{function_type = (tensor<4xi32>, tensor<4xi32>) -> tensor<4xi32>, sym_name = "fuzz_tensor_addition"}> ({
  ^bb0(%arg0: tensor<4xi32>, %arg1: tensor<4xi32>):
    ...
    %3 = "arith.cmpi"("eq", %2, %arg1) : (tensor<4xi32>, tensor<4xi32>) -> tensor<4xi1>
