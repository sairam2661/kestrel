"builtin.module"() ({
  "func.func"() <{function_type = (tensor<4xi32>, tensor<4xi32>) -> i32, sym_name = "tensor_insert_extract"}> ({
  ^bb0(%arg0: tensor<4xi32>, %arg1: tensor<4xi32>):
    ...
    %5 = "tensor.insert"(%arg1, %4, %0) : (tensor<4xi32>, i32, index) -> tensor<4xi32>
    ...
    %13 = "arith.addi"(%9, %10) <{overflowFlags = #arith_overflownone}> : (i32, i32) -> i32
    %14 = "arith.addi"(%13, %11) <{overflowFlags = #arith_overflownone}> : (i32, i32) -> i32
    %15 = "arith.addi"(%14, %12) <{overflowFlags = #arith_overflownone}> : (i32, i32) -> i32
    "func.return"(%15) : (i32) -> ()
  }) : () -> ()
}) : () -> ()