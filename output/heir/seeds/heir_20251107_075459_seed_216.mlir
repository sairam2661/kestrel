"builtin.module"() ({
  "func.func"() <{function_type = (tensor<4xi32>, tensor<4xi32>) -> i32, sym_name = "tensor_mixer"}> ({
  ^bb0(%arg0: tensor<4xi32>, %arg1: tensor<4xi32>):
    ...
    %16 = "arith.muli"(%12, %13) <{overflowFlags = #arith_overflownone}> : (i32, i32) -> i32
    %17 = "arith.muli"(%14, %15) <{overflowFlags = #arith_overflownone}> : (i32, i32) -> i32
    %18 = "arith.addi"(%16, %17) <{overflowFlags = #arith_overflownone}> : (i32, i32) -> i32
    %19 = "arith.select"(%18, %16, %17) : (i32, i32, i32) -> i32
    "func.return"(%19) : (i32) -> ()
  }) : () -> ()
}) : () -> ()