"builtin.module"() ({
  ...
  ^bb0(%arg0: tensor<4xi32>, %arg1: tensor<4xi32>):
    ...
    %16 = "tensor.insert"(%12, %arg1, %0) : (i32, tensor<4xi32>, index) -> tensor<4xi32>
    %17 = "tensor.insert"(%13, %arg1, %1) : (i32, tensor<4xi32>, index) -> tensor<4xi32>
    %18 = "tensor.insert"(%14, %arg1, %2) : (i32, tensor<4xi32>, index) -> tensor<4xi32>
    %19 = "tensor.insert"(%15, %arg1, %3) : (i32, tensor<4xi32>, index) -> tensor<4xi32>
