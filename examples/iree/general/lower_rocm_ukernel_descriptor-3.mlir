...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<1x2x8x4x16x2x8xi8>, tensor<1x2x4x2x4x16x2x8xi8>, tensor<1x1x8x4x2x4x16x4xi32>) -> tensor<1x1x8x4x2x4x16x4xi32>, sym_name = "multi_mma_mfma_i32_16x16x32_i8_without_gpu_arch"}> ({
