...
#translation = #iree_codegen.translation_info<pipeline = LLVMGPUVectorDistribute workgroup_size = [128, 1, 1] subgroup_size = 64, {gpu_pipeline_options = #iree_gpu.pipeline_options<prefetch_shared_memory = false, no_reduce_shared_memory_bank_conflicts = false, use_igemm_convolution = false>}>
"builtin.module"() ({
      ...
      "builtin.module"() ({
        "func.func"() <{function_type = () -> (), sym_name = "matvec_dispatch_0_matmul_transpose_b_32000x2x4096_f16xf16xf32"}> ({
          ...
          ^bb0(%arg0: f16, %arg1: f16, %arg2: f32):
            ...
            "linalg.yield"(%13) : (f32) -> ()
          }) {lowering_config = #iree_gpu.lowering_config<{lane_basis = [[1, 1, 64], [0, 1, 2]], partial_reduction = [0, 0, 512], subgroup_basis = [[1, 1, 2], [0, 1, 2]], thread = [0, 0, 4], workgroup = [16, 1, 0]}>} : (tensor<32000x4096xf16>, tensor<2x4096xf16>, tensor<32000x2xf32>) -> tensor<32000x2xf32>
