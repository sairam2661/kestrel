...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<1x256x4096xf8E4M3FNUZ>, tensor<1024x4096xf8E4M3FNUZ>) -> tensor<1x256x1024xf32>, sym_name = "matmul_f8_large_expanded"}> ({
  ^bb0(%arg0: tensor<1x256x4096xf8E4M3FNUZ>, %arg1: tensor<1024x4096xf8E4M3FNUZ>):
    ...
    ^bb0(%arg2: f8E4M3FNUZ, %arg3: f8E4M3FNUZ, %arg4: f32):
      ...
      "linalg.yield"(%7) : (f32) -> ()
    }) : (tensor<1x256x4096xf8E4M3FNUZ>, tensor<1024x4096xf8E4M3FNUZ>, tensor<1x256x1024xf32>) -> tensor<1x256x1024xf32>
