...
#translation = #iree_codegen.translation_info<pipeline = LLVMGPUTileAndFuse workgroup_size = [128, 1, 1] subgroup_size = 64>
"builtin.module"() ({
      ...
      "builtin.module"() ({
        "func.func"() <{function_type = () -> (), sym_name = "matmul_transpose_b"}> ({
          ...
          ^bb0(%arg0: f16, %arg1: f16, %arg2: f32):
            ...
            "linalg.yield"(%13) : (f32) -> ()
          }) {lowering_config = #iree_gpu.lowering_config<{promote_operands = [0, 1], reduction = [0, 0, 4], thread = [8, 4], workgroup = [64, 64, 0]}>} : (tensor<2048x1280xf16>, tensor<10240x1280xf16>, tensor<2048x10240xf32>) -> tensor<2048x10240xf32>
