...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "matmul_f8_f8_f32_medium_lowering_ukernel_provider"}> ({
    ...
    %4 = "hal.interface.binding.subspan"(%0, %1, %3) <{alignment = 64 : index, binding = 0 : index, layout = #pipeline_layout, operandSegmentSizes = array<i32: 1, 2>}> : (index, index, index) -> !iree_tensor_ext.dispatch.tensor<readonly:tensor<?x?xf8E4M3FNUZ, #encoding>>
    %5 = "hal.interface.binding.subspan"(%0, %3, %2) <{alignment = 64 : index, binding = 1 : index, layout = #pipeline_layout, operandSegmentSizes = array<i32: 1, 2>}> : (index, index, index) -> !iree_tensor_ext.dispatch.tensor<readonly:tensor<?x?xf8E4M3FNUZ, #encoding1>>
    ...
    ^bb0(%arg0: f8E4M3FNUZ, %arg1: f8E4M3FNUZ, %arg2: f32):
      %11 = "arith.extf"(%arg0) : (f8E4M3FNUZ) -> f32
      %12 = "arith.extf"(%arg1) : (f8E4M3FNUZ) -> f32
      ...
      "linalg.yield"(%14) : (f32) -> ()
    }) : (tensor<?x?xf8E4M3FNUZ, #encoding>, tensor<?x?xf8E4M3FNUZ, #encoding1>, tensor<?x?xf32, #encoding2>) -> tensor<?x?xf32, #encoding2>
