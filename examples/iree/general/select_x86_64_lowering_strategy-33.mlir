...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "pack"}> ({
    ...
    %3 = "hal.interface.binding.subspan"(%0) <{alignment = 64 : index, binding = 1 : index, layout = #pipeline_layout, operandSegmentSizes = array<i32: 1, 0>}> : (index) -> !iree_tensor_ext.dispatch.tensor<writeonly:tensor<2x48x16x1xf32>>
    ...
    %5 = "tensor.empty"() : () -> tensor<2x48x16x1xf32>
    %6 = "linalg.pack"(%4, %5, %1) <{inner_dims_pos = array<i64: 0, 1>, operandSegmentSizes = array<i32: 1, 1, 1, 0>, static_inner_tiles = array<i64: 16, 1>}> : (tensor<20x48xf32>, tensor<2x48x16x1xf32>, f32) -> tensor<2x48x16x1xf32>
    "iree_tensor_ext.dispatch.tensor.store"(%6, %3) <{operandSegmentSizes = array<i32: 1, 1, 0, 0, 0, 0>, static_offsets = array<i64: 0, 0, 0, 0>, static_sizes = array<i64: 2, 48, 16, 1>, static_strides = array<i64: 1, 1, 1, 1>}> : (tensor<2x48x16x1xf32>, !iree_tensor_ext.dispatch.tensor<writeonly:tensor<2x48x16x1xf32>>) -> ()
    "func.return"() : () -> ()
