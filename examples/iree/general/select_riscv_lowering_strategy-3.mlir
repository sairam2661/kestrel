...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<1x512xf32>, tensor<512x128xf32>) -> tensor<1x128xf32>, sym_name = "matmul_gemv_riscv_vl512"}> ({
  ^bb0(%arg0: tensor<1x512xf32>, %arg1: tensor<512x128xf32>):
    %0 = "arith.constant"() <{value = 0.000000e+00 : f32}> : () -> f32
    %1 = "tensor.empty"() : () -> tensor<1x128xf32>
    %2 = "linalg.fill"(%0, %1) <{operandSegmentSizes = array<i32: 1, 1>}> ({
    ^bb0(%arg5: f32, %arg6: f32):
      "linalg.yield"(%arg5) : (f32) -> ()
    }) : (f32, tensor<1x128xf32>) -> tensor<1x128xf32>
    ...
    ^bb0(%arg2: f32, %arg3: f32, %arg4: f32):
      ...
      "linalg.yield"(%5) : (f32) -> ()
    }) : (tensor<1x512xf32>, tensor<512x128xf32>, tensor<1x128xf32>) -> tensor<1x128xf32>
