...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "set_encoding_dynamic"}> ({
    ...
    %4 = "hal.interface.binding.subspan"(%0, %1, %2) <{alignment = 64 : index, binding = 1 : index, layout = #pipeline_layout, operandSegmentSizes = array<i32: 1, 2>}> : (index, index, index) -> !iree_tensor_ext.dispatch.tensor<writeonly:tensor<?x?xf32, #encoding>>
