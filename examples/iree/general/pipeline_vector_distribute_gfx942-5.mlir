...
"builtin.module"() ({
  "hal.executable"() <{sym_name = "matmul_256x256x256_i8_i32"}> ({
    "hal.executable.variant"() <{sym_name = "rocm", target = #executable_target_rocm_hsaco_fb}> ({
      "hal.executable.export"() <{layout = #pipeline_layout, sym_name = "matmul_256x256x256_i8_i32", sym_visibility = "public"}> ({
      ...
      "builtin.module"() ({
        "func.func"() <{function_type = () -> (), sym_name = "matmul_256x256x256_i8_i32"}> ({
          ...
          ^bb0(%arg0: i8, %arg1: i8, %arg2: i32):
            ...
            "linalg.yield"(%13) : (i32) -> ()
          }) {lowering_config = #iree_gpu.lowering_config<{mma_kind = #iree_gpu.mma_layout<MFMA_I32_16x16x32_I8>, promote_operands = [0, 1], reduction = [0, 0, 256], subgroup_basis = [[2, 2, 1], [0, 1, 2]], workgroup = [64, 64, 0]}>} : (tensor<256x256xi8>, tensor<256x256xi8>, tensor<256x256xi32>) -> tensor<256x256xi32>
