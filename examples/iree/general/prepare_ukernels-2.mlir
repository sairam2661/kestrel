#executable_target_xyz = #hal.executable.target<"llvm-cpu", "xyz", {cpu_features = "", target_triple = "x86_64-xyz-xyz", ukernels = ""}>
...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<1x10x32x8x1xf32>, tensor<1x80x32x4x1xf32>, tensor<1x10x80x8x4xf32>) -> tensor<1x10x80x8x4xf32>, sym_name = "do_not_decompose_batch_mmt4d"}> ({
