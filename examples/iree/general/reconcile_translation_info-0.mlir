...
"builtin.module"() ({
  "hal.executable"() <{sym_name = "reconcile_workgroup_size", sym_visibility = "private"}> ({
    "hal.executable.variant"() <{sym_name = "reconcile_workgroup_size", sym_visibility = "public", target = #executable_target_}> ({
