...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "tile_from_tensor_load_inplace"}> ({
    ...
    ^bb0(%arg0: index):
      ...
      ^bb0(%arg1: index):
        ...
        ^bb0(%arg2: f32, %arg3: f32, %arg4: f32):
          %15 = "arith.mulf"(%arg2, %arg3) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
