...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "pack_at_dest"}> ({
    ...
    %5 = "util.optimization_barrier"(%3) : (tensor<16x16xf32>) -> tensor<16x16xf32>
    %6 = "linalg.pack"(%5, %4) <{inner_dims_pos = array<i64: 0, 1>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, static_inner_tiles = array<i64: 4, 4>}> : (tensor<16x16xf32>, tensor<4x4x4x4xf32>) -> tensor<4x4x4x4xf32>
