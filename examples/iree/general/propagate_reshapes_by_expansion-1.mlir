...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "expand_dest_forall"}> ({
    ...
    ^bb0(%arg0: index, %arg1: index, %arg2: tensor<?x64x32xf32>):
      ...
      %9 = "util.optimization_barrier"(%8) : (tensor<1x16x2x4x2xf32>) -> tensor<1x16x2x4x2xf32>
      %10 = "tensor.collapse_shape"(%9) <{reassociation = [[0], [1], [2, 3, 4]]}> : (tensor<1x16x2x4x2xf32>) -> tensor<1x16x16xf32>
      "scf.forall.in_parallel"() ({
        "tensor.parallel_insert_slice"(%10, %arg2, %1, %arg0, %arg1) <{operandSegmentSizes = array<i32: 1, 1, 3, 0, 0>, static_offsets = array<i64: -9223372036854775808, -9223372036854775808, -9223372036854775808>, static_sizes = array<i64: 1, 16, 16>, static_strides = array<i64: 1, 1, 1>}> : (tensor<1x16x16xf32>, tensor<?x64x32xf32>, index, index, index) -> ()
      }) : () -> ()
