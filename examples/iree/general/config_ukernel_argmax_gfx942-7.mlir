...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<1x?xf32>) -> tensor<1xi64>, sym_name = "argmax_2d_f32i64_custom_bitcode"}> ({
  ...
  }) {hal.executable.objects = [#hal.executable.object<{path = "iree_uk_amdgpu_argmax_f32i64.gfx942.bc", data = dense<[66, 67, -64, -34, 1, 35, 69, 103, -119, -85, -51, -17]> : tensor<12xi8>}>], hal.executable.target = #executable_target_rocm_hsaco_fb} : () -> ()
}) : () -> ()
