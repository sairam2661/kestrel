...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<?x?xf32>, tensor<?x?xf32>, tensor<?x?xf32>) -> tensor<?x?xf32>, sym_name = "ukernel_impl_dynamic", sym_visibility = "private"}> ({
  }) : () -> ()
  "func.func"() <{function_type = (tensor<?x?xf32>, tensor<?x?xf32>, tensor<?x?xf32>) -> tensor<?x?xf32>, sym_name = "test"}> ({
  ^bb0(%arg7: tensor<?x?xf32>, %arg8: tensor<?x?xf32>, %arg9: tensor<?x?xf32>):
    %6 = "func.call"(%arg7, %arg8, %arg9) <{callee = @ukernel_impl_dynamic}> : (tensor<?x?xf32>, tensor<?x?xf32>, tensor<?x?xf32>) -> tensor<?x?xf32>
    "func.return"(%6) : (tensor<?x?xf32>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = (tensor<16x32xf32>, tensor<16x32xf32>) -> tensor<16x16xf32>, sym_name = "replace_generic_with_ukernel_impl_and_cast"}> ({
