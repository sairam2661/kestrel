...
"builtin.module"() ({
  "hal.executable"() <{sym_name = "warp_reduction_dispatch"}> ({
    "hal.executable.variant"() <{sym_name = "cuda", target = #executable_target_cuda_nvptx_fb}> ({
      "hal.executable.export"() <{layout = #pipeline_layout, sym_name = "warp_reduction_dispatch", sym_visibility = "public"}> ({
      ...
      "builtin.module"() ({
        "func.func"() <{function_type = () -> (), sym_name = "warp_reduction_dispatch"}> ({
