#executable_target_embedded_elf_riscv_64 = #hal.executable.target<"llvm-cpu", "embedded-elf-riscv_64", {cpu_features = "+m,+a,+f,+d,+c,+zvl512b,+zve64x", data_layout = "e-m:e-p:64:64-i64:64-i128:128-n64-S128", native_vector_size = 512 : index, target_triple = "riscv64-none-elf"}>
...
"builtin.module"() ({
  "hal.executable"() <{sym_name = "apply_scale_zve64x", sym_visibility = "private"}> ({
    "hal.executable.variant"() <{sym_name = "embedded_elf_riscv_64", sym_visibility = "public", target = #executable_target_embedded_elf_riscv_64}> ({
      "hal.executable.export"() <{layout = #pipeline_layout, ordinal = 0 : index, sym_name = "apply_scale_zve64x", sym_visibility = "public"}> ({
      ...
      "builtin.module"() ({
        "func.func"() <{function_type = () -> (), sym_name = "apply_scale_zve64x"}> ({
