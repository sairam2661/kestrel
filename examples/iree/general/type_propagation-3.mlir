...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "generic_op_illegal_result"}> ({
    ...
    %4 = "tensor.empty"(%0) : (index) -> tensor<?xi1>
    ...
    ^bb0(%arg0: i8, %arg1: i1):
      %7 = "arith.trunci"(%arg0) <{overflowFlags = #arith.overflow<none>}> : (i8) -> i1
      "linalg.yield"(%7) : (i1) -> ()
    }) : (tensor<?xi8>, tensor<?xi1>) -> tensor<?xi1>
    %6 = "arith.extui"(%5) : (tensor<?xi1>) -> tensor<?xi8>
