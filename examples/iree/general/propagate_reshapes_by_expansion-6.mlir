...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "noexpand_dest_forall_nomapping"}> ({
    ...
    %3 = "scf.forall"(%2) <{operandSegmentSizes = array<i32: 0, 0, 0, 1>, staticLowerBound = array<i64: 0>, staticStep = array<i64: 16>, staticUpperBound = array<i64: 32>}> ({
