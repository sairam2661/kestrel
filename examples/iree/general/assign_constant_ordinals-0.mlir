...
"builtin.module"() ({
  "hal.executable"() <{sym_name = "executable", sym_visibility = "private"}> ({
    "hal.executable.variant"() <{sym_name = "variant", sym_visibility = "public", target = #executable_target_embedded_elf_x86_64}> ({
      ...
      "builtin.module"() ({
        "llvm.mlir.global"() <{addr_space = 0 : i32, global_type = i32, linkage = #llvm.linkage<internal>, sym_name = "__constant_ordinal_foo_a", unnamed_addr = 0 : i64, visibility_ = 0 : i64}> ({
        }) {hal.executable.constant.key = "foo", sym_visibility = "private"} : () -> ()
        "llvm.mlir.global"() <{addr_space = 0 : i32, global_type = i32, linkage = #llvm.linkage<internal>, sym_name = "__constant_ordinal_foo_b", unnamed_addr = 0 : i64, visibility_ = 0 : i64}> ({
        }) {hal.executable.constant.key = "foo", sym_visibility = "private"} : () -> ()
        "llvm.mlir.global"() <{addr_space = 0 : i32, global_type = i32, linkage = #llvm.linkage<internal>, sym_name = "__constant_ordinal_bar", unnamed_addr = 0 : i64, visibility_ = 0 : i64}> ({
