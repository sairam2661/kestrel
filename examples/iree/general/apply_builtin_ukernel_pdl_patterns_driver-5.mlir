...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<1024x4096xbf16>, tensor<1024x4096xbf16>) -> tensor<1024x1024xf32>, sym_name = "matmul_bf16_large"}> ({
  ^bb0(%arg0: tensor<1024x4096xbf16>, %arg1: tensor<1024x4096xbf16>):
    ...
    ^bb0(%arg2: bf16, %arg3: bf16, %arg4: f32):
      ...
      "linalg.yield"(%7) : (f32) -> ()
    }) : (tensor<1024x4096xbf16>, tensor<1024x4096xbf16>, tensor<1024x1024xf32>) -> tensor<1024x1024xf32>
    "func.return"(%3) : (tensor<1024x1024xf32>) -> ()
  }) : () -> ()
