...
"builtin.module"() ({
  ...
  "util.func"() <{function_type = () -> (i32, i32), sym_name = "no_resolve_without_topology", sym_visibility = "public", tied_operands = [-1 : index, -1 : index]}> ({
    %0:2 = "hal.allocator.resolve_memory_properties"() <{affinity = #hal.device.optimal<[#hal.device.affinity<@device_a>, #hal.device.affinity<@device_b>]>, lifetime = 5 : i32}> : () -> (i32, i32)
