...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<2x256x128xf32>, tensor<2x256x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>, sym_name = "batch_matmul_transpose_a_f32f32f32"}> ({
  ^bb0(%arg0: tensor<2x256x128xf32>, %arg1: tensor<2x256x512xf32>, %arg2: tensor<2x128x512xf32>):
    ...
    %5 = "iree_encoding.set_encoding"(%arg0) : (tensor<2x256x128xf32>) -> tensor<2x256x128xf32, #encoding>
    %6 = "iree_encoding.set_encoding"(%arg1) : (tensor<2x256x512xf32>) -> tensor<2x256x512xf32, #encoding1>
    ...
    ^bb0(%arg3: f32, %arg4: f32, %arg5: f32):
      ...
      "linalg.yield"(%11) : (f32) -> ()
    }) : (tensor<2x256x128xf32, #encoding>, tensor<2x256x512xf32, #encoding1>, tensor<2x128x512xf32, #encoding2>) -> tensor<2x128x512xf32, #encoding2>
