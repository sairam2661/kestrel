...
"builtin.module"() ({
  "hal.executable"() <{sym_name = "multiple_specialization_executable", sym_visibility = "private"}> ({
      ...
      "builtin.module"() ({
        "func.func"() <{function_type = () -> (), sym_name = "matmul_transpose_b_Dx1024x4096_f16xf16xf32"}> ({
          ...
          ^bb0(%arg0: f16, %arg1: f16, %arg2: f32):
            ...
            "linalg.yield"(%17) : (f32) -> ()
          }) {iree_codegen.specialization_ranges = #util<int.assumption.multi_array[[<umin = 128, umax = 4096, udiv = 128>, <umin = 128, umax = 4096, udiv = 128>, <umin = 64, udiv = 64>], [<umin = 0, udiv = 512>, <umin = 0, udiv = 512>, <udiv = 64>], [<udiv = 16>, <udiv = 16>, <udiv = 64>], [<umin = 0, udiv = 512>, <umin = 0, udiv = 512>, <udiv = 64>]]>} : (tensor<?x4096xf16>, tensor<1024x4096xf16>, tensor<?x1024xf32>) -> tensor<?x1024xf32>
