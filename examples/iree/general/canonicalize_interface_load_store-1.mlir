...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "fold_reshape_store"}> ({
    ...
    "iree_tensor_ext.dispatch.tensor.store"(%8, %4, %0, %0, %1) <{operandSegmentSizes = array<i32: 1, 1, 0, 2, 0, 1>, static_offsets = array<i64: -9223372036854775808, -9223372036854775808, 0>, static_sizes = array<i64: 3, 3, 96>, static_strides = array<i64: 1, -9223372036854775808, 1>}> : (tensor<3x3x96xf32>, !iree_tensor_ext.dispatch.tensor<writeonly:tensor<3x3x96xf32>>, index, index, index) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
