...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "tile_from_pointwise_lhs_inplace"}> ({
    ...
    ^bb0(%arg0: index):
      ...
      ^bb0(%arg1: index):
        ...
        %13 = "bufferization.alloc_tensor"() <{operandSegmentSizes = array<i32: 0, 0, 0>}> : () -> tensor<1x3xf32>
        %14 = "linalg.generic"(%11, %13) <{indexing_maps = [#map, #map], iterator_types = [#linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>], operandSegmentSizes = array<i32: 1, 1>}> ({
        ^bb0(%arg5: f32, %arg6: f32):
          %19 = "arith.addf"(%arg5, %arg5) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
          "linalg.yield"(%19) : (f32) -> ()
        ...
        %16 = "linalg.matmul"(%14, %12, %15) <{indexing_maps = [#map1, #map2, #map3], operandSegmentSizes = array<i32: 2, 1>}> ({
