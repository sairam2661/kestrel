...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "dispatch_tensor_load_and_store_slices"}> ({
    ...
    "iree_tensor_ext.dispatch.tensor.store"(%2, %1) <{operandSegmentSizes = array<i32: 1, 1, 0, 0, 0, 0>, static_offsets = array<i64: 4>, static_sizes = array<i64: 12>, static_strides = array<i64: 1>}> : (tensor<12xf32>, !iree_tensor_ext.dispatch.tensor<writeonly:tensor<16xf32>>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
