...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "reshape_fused_source"}> ({
    ...
    "iree_tensor_ext.dispatch.tensor.store"(%10, %6) <{operandSegmentSizes = array<i32: 1, 1, 0, 0, 0, 0>, static_offsets = array<i64: 0, 0>, static_sizes = array<i64: 3, 4>, static_strides = array<i64: 1, 1>}> : (tensor<3x4xi32>, !iree_tensor_ext.dispatch.tensor<writeonly:tensor<3x4xi32>>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
