...
"builtin.module"() ({
  "hal.executable"() <{sym_name = "split_reduction_2d_permuted_mapping_executable", sym_visibility = "private"}> ({
    "hal.executable.variant"() <{sym_name = "split_reduction_2d_permuted_mapping_variant", sym_visibility = "public", target = #executable_target_}> ({
      "hal.executable.export"() <{layout = #pipeline_layout, sym_name = "split_reduction_2d_permuted_mapping", sym_visibility = "public"}> ({
      ^bb0(%arg6: !hal.device, %arg7: index, %arg8: index, %arg9: index, %arg10: index, %arg11: index, %arg12: index):
        %12:3 = "iree_tensor_ext.dispatch.workgroup_count_from_slice"(%arg7, %arg8, %arg9, %arg10, %arg11, %arg12) : (index, index, index, index, index, index) -> (index, index, index)
        %13:3 = "iree_tensor_ext.dispatch.workgroup_count_split_reduction_modifier"(%12#0, %12#1, %12#2, %arg7, %arg8, %arg9, %arg10, %arg11, %arg12) : (index, index, index, index, index, index, index, index, index) -> (index, index, index)
        "hal.return"(%13#0, %13#1, %13#2) : (index, index, index) -> ()
      }, {
      }) : () -> ()
      "builtin.module"() ({
        "func.func"() <{function_type = () -> (), sym_name = "split_reduction_2d_permuted_mapping"}> ({
