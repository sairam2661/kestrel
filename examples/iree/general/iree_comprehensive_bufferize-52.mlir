...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "iree_linalg_ext_pack"}> ({
    ...
    %6 = "iree_linalg_ext.pack"(%5, %4, %1) <{inner_dims_pos = array<i64: 0, 1>, operandSegmentSizes = array<i32: 1, 1, 0, 1>, static_inner_tiles = array<i64: 3, 3>}> : (tensor<4x4xi32>, tensor<2x2x3x3xi32>, i32) -> tensor<2x2x3x3xi32>
