...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "transpose_102"}> ({
    ...
    %3 = "hal.interface.binding.subspan"(%1) <{alignment = 64 : index, binding = 1 : index, layout = #pipeline_layout, operandSegmentSizes = array<i32: 1, 0>}> : (index) -> !iree_tensor_ext.dispatch.tensor<writeonly:tensor<96x64x128xf32>>
    ...
    %5 = "iree_tensor_ext.dispatch.tensor.load"(%3) <{operandSegmentSizes = array<i32: 1, 0, 0, 0, 0>, static_offsets = array<i64: 0, 0, 0>, static_sizes = array<i64: 96, 64, 128>, static_strides = array<i64: 1, 1, 1>}> : (!iree_tensor_ext.dispatch.tensor<writeonly:tensor<96x64x128xf32>>) -> tensor<96x64x128xf32>
    ...
    }) : (tensor<64x96x128xf32>, tensor<96x64x128xf32>) -> tensor<96x64x128xf32>
    "iree_tensor_ext.dispatch.tensor.store"(%6, %3) <{operandSegmentSizes = array<i32: 1, 1, 0, 0, 0, 0>, static_offsets = array<i64: 0, 0, 0>, static_sizes = array<i64: 96, 64, 128>, static_strides = array<i64: 1, 1, 1>}> : (tensor<96x64x128xf32>, !iree_tensor_ext.dispatch.tensor<writeonly:tensor<96x64x128xf32>>) -> ()
    "func.return"() : () -> ()
