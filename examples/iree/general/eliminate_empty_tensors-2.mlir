...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "eliminate_empty_tensors_with_store_to_buffer_op"}> ({
    ...
    %3 = "iree_codegen.load_from_buffer"(%1) : (memref<128xf32, #hal.descriptor_type<storage_buffer>>) -> tensor<128xf32>
