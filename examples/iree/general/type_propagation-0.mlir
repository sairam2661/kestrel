...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "generic_op_illegal_operand"}> ({
    ...
    %4 = "arith.trunci"(%3) <{overflowFlags = #arith.overflow<none>}> : (tensor<?xi8>) -> tensor<?xi1>
    ...
    ^bb0(%arg0: i1, %arg1: i8):
      %7 = "arith.extui"(%arg0) : (i1) -> i8
      "linalg.yield"(%7) : (i8) -> ()
    }) : (tensor<?xi1>, tensor<?xi8>) -> tensor<?xi8>
