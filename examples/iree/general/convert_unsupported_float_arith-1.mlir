...
"builtin.module"() ({
  "func.func"() <{function_type = (f8E5M2FNUZ) -> f8E5M2FNUZ, sym_name = "expand_f8"}> ({
  ^bb0(%arg0: f8E5M2FNUZ):
    %0 = "arith.constant"() <{value = 1.000000e+00 : f8E5M2FNUZ}> : () -> f8E5M2FNUZ
    %1 = "arith.addf"(%arg0, %0) <{fastmath = #arith.fastmath<none>}> : (f8E5M2FNUZ, f8E5M2FNUZ) -> f8E5M2FNUZ
    "func.return"(%1) : (f8E5M2FNUZ) -> ()
