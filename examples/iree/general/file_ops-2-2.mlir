"builtin.module"() ({
  "util.func"() <{function_type = (!stream.timepoint, !stream.file, !stream.resource<variable>) -> !stream.timepoint, sym_name = "file_write", sym_visibility = "public", tied_operands = [-1 : index]}> ({
