...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "sort2D_static_shape"}> ({
    ...
    %2 = "iree_tensor_ext.dispatch.tensor.load"(%1) <{operandSegmentSizes = array<i32: 1, 0, 0, 0, 0>, static_offsets = array<i64: 0, 0>, static_sizes = array<i64: 2000, 30000>, static_strides = array<i64: 1, 1>}> : (!iree_tensor_ext.dispatch.tensor<readwrite:tensor<2000x30000xi32>>) -> tensor<2000x30000xi32>
    ...
    }) : (tensor<2000x30000xi32>) -> tensor<2000x30000xi32>
