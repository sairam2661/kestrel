...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "multi_use_unpack_fold"}> ({
    ...
    %6 = "linalg.unpack"(%4, %5) <{inner_dims_pos = array<i64: 0, 1>, static_inner_tiles = array<i64: 4, 4>}> : (tensor<4x4x4x4xf32>, tensor<16x16xf32>) -> tensor<16x16xf32>
    ...
    "iree_tensor_ext.dispatch.tensor.store"(%6, %3) <{operandSegmentSizes = array<i32: 1, 1, 0, 0, 0, 0>, static_offsets = array<i64: 0, 0>, static_sizes = array<i64: 16, 16>, static_strides = array<i64: 1, 1>}> : (tensor<16x16xf32>, !iree_tensor_ext.dispatch.tensor<readwrite:tensor<16x16xf32>>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
