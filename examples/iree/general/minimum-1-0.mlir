"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "tensor_i32"}> ({
    %30 = "util.unfoldable_constant"() <{value = dense<[1, 2, 7, 4]> : tensor<4xi32>}> : () -> tensor<4xi32>
    %31 = "util.unfoldable_constant"() <{value = dense<[5, 2, 3, 4]> : tensor<4xi32>}> : () -> tensor<4xi32>
    %32 = "stablehlo.minimum"(%30, %31) : (tensor<4xi32>, tensor<4xi32>) -> tensor<4xi32>
    "check.expect_eq_const"(%32) <{value = dense<[1, 2, 3, 4]> : tensor<4xi32>}> : (tensor<4xi32>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> (), sym_name = "tensor_odd_dim"}> ({
    %27 = "util.unfoldable_constant"() <{value = dense<[1, 2, 7]> : tensor<3xi32>}> : () -> tensor<3xi32>
    %28 = "util.unfoldable_constant"() <{value = dense<[5, 2, 3]> : tensor<3xi32>}> : () -> tensor<3xi32>
    %29 = "stablehlo.minimum"(%27, %28) : (tensor<3xi32>, tensor<3xi32>) -> tensor<3xi32>
    "check.expect_eq_const"(%29) <{value = dense<[1, 2, 3]> : tensor<3xi32>}> : (tensor<3xi32>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> (), sym_name = "scalar_i32"}> ({
    ...
    %26 = "stablehlo.minimum"(%24, %25) : (tensor<i32>, tensor<i32>) -> tensor<i32>
    "check.expect_eq_const"(%26) <{value = dense<1> : tensor<i32>}> : (tensor<i32>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> (), sym_name = "negative_i32"}> ({
    ...
    %23 = "stablehlo.minimum"(%21, %22) : (tensor<i32>, tensor<i32>) -> tensor<i32>
    "check.expect_eq_const"(%23) <{value = dense<-2> : tensor<i32>}> : (tensor<i32>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> (), sym_name = "i8"}> ({
    ...
    %20 = "stablehlo.minimum"(%18, %19) : (tensor<i8>, tensor<i8>) -> tensor<i8>
    "check.expect_eq_const"(%20) <{value = dense<1> : tensor<i8>}> : (tensor<i8>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> (), sym_name = "i16"}> ({
    ...
    %17 = "stablehlo.minimum"(%15, %16) : (tensor<i16>, tensor<i16>) -> tensor<i16>
    "check.expect_eq_const"(%17) <{value = dense<1> : tensor<i16>}> : (tensor<i16>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> (), sym_name = "i64"}> ({
    ...
    %14 = "stablehlo.minimum"(%12, %13) : (tensor<i64>, tensor<i64>) -> tensor<i64>
    "check.expect_eq_const"(%14) <{value = dense<1> : tensor<i64>}> : (tensor<i64>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
