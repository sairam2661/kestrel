...
#translation1 = #iree_codegen.translation_info<pipeline = None>
"builtin.module"() ({
  "hal.executable"() <{sym_name = "err_mistmatched_workgroup_size2", sym_visibility = "private"}> ({
    "hal.executable.variant"() <{sym_name = "err_mismatched_workgroup_size2", sym_visibility = "public", target = #executable_target_}> ({
