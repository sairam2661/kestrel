...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "argmax_1d_bf16i64"}> ({
    %0 = "arith.constant"() <{value = 32 : i64}> : () -> i64
    %1 = "arith.constant"() <{value = 0xFF80 : bf16}> : () -> bf16
    ...
    %13 = "hal.interface.binding.subspan"(%3, %12) <{alignment = 64 : index, binding = 0 : index, descriptor_flags = 1 : i32, layout = #pipeline_layout, operandSegmentSizes = array<i32: 1, 1>}> : (index, index) -> !iree_tensor_ext.dispatch.tensor<readonly:tensor<?xbf16>>
    %14 = "iree_tensor_ext.dispatch.tensor.load"(%13, %12, %12) <{operandSegmentSizes = array<i32: 1, 1, 0, 1, 0>, static_offsets = array<i64: 0>, static_sizes = array<i64: -9223372036854775808>, static_strides = array<i64: 1>}> : (!iree_tensor_ext.dispatch.tensor<readonly:tensor<?xbf16>>, index, index) -> tensor<?xbf16>
    %15 = "tensor.empty"() : () -> tensor<i64>
    %16 = "tensor.empty"() : () -> tensor<bf16>
    ...
    ^bb0(%arg3: bf16, %arg4: bf16):
      "linalg.yield"(%arg3) : (bf16) -> ()
    }) : (bf16, tensor<bf16>) -> tensor<bf16>
    ...
    ^bb0(%arg0: bf16, %arg1: bf16, %arg2: i64):
      %20 = "linalg.index"() <{dim = 0 : i64}> : () -> index
      %21 = "arith.index_cast"(%20) : (index) -> i64
      %22 = "arith.maximumf"(%arg0, %arg1) <{fastmath = #arith.fastmath<none>}> : (bf16, bf16) -> bf16
      %23 = "arith.cmpf"(%arg0, %arg1) <{fastmath = #arith.fastmath<none>, predicate = 2 : i64}> : (bf16, bf16) -> i1
      %24 = "arith.select"(%23, %21, %arg2) : (i1, i64, i64) -> i64
      "linalg.yield"(%22, %24) : (bf16, i64) -> ()
    }) : (tensor<?xbf16>, tensor<bf16>, tensor<i64>) -> (tensor<bf16>, tensor<i64>)
