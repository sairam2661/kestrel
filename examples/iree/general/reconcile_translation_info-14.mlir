...
"builtin.module"() ({
  "hal.executable"() <{sym_name = "multiple_scf_forall_ops", sym_visibility = "private"}> ({
    "hal.executable.variant"() <{sym_name = "multiple_scf_forall_ops", sym_visibility = "public", target = #executable_target_}> ({
      "hal.executable.export"() <{layout = #pipeline_layout, sym_name = "multiple_scf_forall_ops", sym_visibility = "public"}> ({
      ...
      "builtin.module"() ({
        "func.func"() <{function_type = () -> (), sym_name = "multiple_scf_forall_ops"}> ({
          ...
          "scf.forall"(%4, %5, %6, %7) <{mapping = [#iree_codegen.workgroup_mapping<y>, #iree_codegen.workgroup_mapping<x>], operandSegmentSizes = array<i32: 0, 2, 2, 0>, staticLowerBound = array<i64: 0, 0>, staticStep = array<i64: -9223372036854775808, -9223372036854775808>, staticUpperBound = array<i64: -9223372036854775808, -9223372036854775808>}> ({
          ^bb0(%arg2: index, %arg3: index):
            "use"(%arg2, %arg3) : (index, index) -> ()
            "scf.forall.in_parallel"() ({
            ^bb0:
            }) : () -> ()
          }) : (index, index, index, index) -> ()
          "scf.forall"() <{mapping = [#iree_codegen.workgroup_mapping<x>, #iree_codegen.workgroup_mapping<y>], operandSegmentSizes = array<i32: 0, 0, 0, 0>, staticLowerBound = array<i64: 0, 0>, staticStep = array<i64: 4, 2>, staticUpperBound = array<i64: 16, 32>}> ({
