...
"builtin.module"() ({
  "hal.executable"() <{sym_name = "matmul_256x256x512_f16_f32"}> ({
    "hal.executable.variant"() <{sym_name = "rocm", target = #executable_target_rocm_hsaco_fb}> ({
      "hal.executable.export"() <{layout = #pipeline_layout, sym_name = "matmul_256x256x512_f16_f32"}> ({
      ...
      "builtin.module"() ({
        "func.func"() <{function_type = () -> (), sym_name = "matmul_256x256x512_f16_f32"}> ({
          ...
          %6 = "iree_tensor_ext.dispatch.tensor.load"(%3) <{operandSegmentSizes = array<i32: 1, 0, 0, 0, 0>, static_offsets = array<i64: 0, 0>, static_sizes = array<i64: 256, 256>, static_strides = array<i64: 1, 1>}> : (!iree_tensor_ext.dispatch.tensor<readonly:tensor<512x256xf16>>) -> tensor<512x256xf16>
          ...
          ^bb0(%arg0: f16, %arg1: f16, %arg2: f32):
            ...
            "linalg.yield"(%13) : (f32) -> ()
          }) {lowering_config = #iree_gpu.lowering_config<{mma_kind = #iree_gpu.mma_layout<MFMA_F32_16x16x32_F16>, promote_operands = [0, 1], reduction = [0, 0, 256], subgroup_basis = [[2, 2, 1], [0, 1, 2]], workgroup = [64, 64, 0]}>} : (tensor<256x512xf16>, tensor<512x256xf16>, tensor<256x256xf32>) -> tensor<256x256xf32>
