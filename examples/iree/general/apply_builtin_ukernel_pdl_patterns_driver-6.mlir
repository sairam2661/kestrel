...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<1x256x4096xbf16>, tensor<1024x4096xbf16>) -> tensor<1x256x1024xf32>, sym_name = "matmul_bf16_expanded_large"}> ({
  ^bb0(%arg0: tensor<1x256x4096xbf16>, %arg1: tensor<1024x4096xbf16>):
    %0 = "arith.constant"() <{value = 0.000000e+00 : f32}> : () -> f32
    %1 = "tensor.empty"() : () -> tensor<1x256x1024xf32>
    %2 = "linalg.fill"(%0, %1) <{operandSegmentSizes = array<i32: 1, 1>}> ({
    ^bb0(%arg5: f32, %arg6: f32):
      "linalg.yield"(%arg5) : (f32) -> ()
    }) : (f32, tensor<1x256x1024xf32>) -> tensor<1x256x1024xf32>
    ...
    ^bb0(%arg2: bf16, %arg3: bf16, %arg4: f32):
      %4 = "arith.extf"(%arg2) : (bf16) -> f32
      %5 = "arith.extf"(%arg3) : (bf16) -> f32
      %6 = "arith.mulf"(%4, %5) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
      %7 = "arith.addf"(%arg4, %6) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
      "linalg.yield"(%7) : (f32) -> ()
    }) : (tensor<1x256x4096xbf16>, tensor<1024x4096xbf16>, tensor<1x256x1024xf32>) -> tensor<1x256x1024xf32>
    "func.return"(%3) : (tensor<1x256x1024xf32>) -> ()
  }) : () -> ()
