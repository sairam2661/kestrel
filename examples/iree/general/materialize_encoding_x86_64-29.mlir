...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<128x256xf32>, tensor<512x256xf32>, tensor<128x512xf32>) -> tensor<128x512xf32>, sym_name = "matmul_transpose_b_f32f32f32"}> ({
  ^bb0(%arg0: tensor<128x256xf32>, %arg1: tensor<512x256xf32>, %arg2: tensor<128x512xf32>):
    ...
    %4 = "iree_encoding.set_encoding"(%arg0) : (tensor<128x256xf32>) -> tensor<128x256xf32, #encoding>
    %5 = "iree_encoding.set_encoding"(%arg1) : (tensor<512x256xf32>) -> tensor<512x256xf32, #encoding1>
    ...
    ^bb0(%arg3: f32, %arg4: f32, %arg5: f32):
      ...
      "linalg.yield"(%10) : (f32) -> ()
    }) : (tensor<128x256xf32, #encoding>, tensor<512x256xf32, #encoding1>, tensor<128x512xf32, #encoding2>) -> tensor<128x512xf32, #encoding2>
