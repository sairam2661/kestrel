"builtin.module"() ({
  "util.func"() <{function_type = (f32) -> f32, sym_name = "min_max_floor_adj_range", tied_operands = [-1 : index]}> ({
  ^bb0(%arg0: f32):
    %0 = "arith.constant"() <{value = -5.200000e+00 : f32}> : () -> f32
    %1 = "arith.constant"() <{value = 5.200000e+00 : f32}> : () -> f32
