...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "iree_linalg_ext_unpack_fully_dynamic"}> ({
    ...
    %6 = "iree_linalg_ext.unpack"(%5, %4, %1, %1) <{inner_dims_pos = array<i64: 0, 1>, operandSegmentSizes = array<i32: 1, 1, 2>, static_inner_tiles = array<i64: -9223372036854775808, -9223372036854775808>}> : (tensor<2x2x?x?xi32>, tensor<4x4xi32>, index, index) -> tensor<4x4xi32>
