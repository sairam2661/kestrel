...
"builtin.module"() ({
  "func.func"() <{function_type = (vector<4x[2]xf32>, tensor<?x?xf32>, tensor<?x?xf32>, index, index) -> tensor<?x?xf32>, sym_name = "negative_fold_insert_slice_into_transfer_write_scalable"}> ({
  ^bb0(%arg0: vector<4x[2]xf32>, %arg1: tensor<?x?xf32>, %arg2: tensor<?x?xf32>, %arg3: index, %arg4: index):
    ...
    %5 = "vector.transfer_write"(%arg0, %4, %1, %1) <{in_bounds = [true, true], operandSegmentSizes = array<i32: 1, 1, 2, 0>, permutation_map = #map}> : (vector<4x[2]xf32>, tensor<4x?xf32>, index, index) -> tensor<4x?xf32>
