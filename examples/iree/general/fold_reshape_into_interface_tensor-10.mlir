...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<2x?x32xf32>) -> (), sym_name = "fold_collapse_into_stores_dynamic_diff"}> ({
  ^bb0(%arg0: tensor<2x?x32xf32>):
    ...
    %4 = "tensor.collapse_shape"(%arg0) <{reassociation = [[0, 1], [2]]}> : (tensor<2x?x32xf32>) -> tensor<?x32xf32>
