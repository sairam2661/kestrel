...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "fold_dynamic_reshape_load"}> ({
    ...
    %8 = "tensor.collapse_shape"(%7) <{reassociation = [[0, 1]]}> : (tensor<?x?xf32>) -> tensor<?xf32>
    %9 = "tensor.expand_shape"(%8, %3, %4) <{reassociation = [[0, 1]], static_output_shape = array<i64: -9223372036854775808, -9223372036854775808>}> : (tensor<?xf32>, index, index) -> tensor<?x?xf32>
