...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<1x256x4096xf16>, tensor<1024x4096xf16>) -> tensor<1x256x1024xf32>, sym_name = "matmul_f16_large_expanded"}> ({
  ^bb0(%arg0: tensor<1x256x4096xf16>, %arg1: tensor<1024x4096xf16>):
    ...
    ^bb0(%arg2: f16, %arg3: f16, %arg4: f32):
      ...
      "linalg.yield"(%7) : (f32) -> ()
    }) : (tensor<1x256x4096xf16>, tensor<1024x4096xf16>, tensor<1x256x1024xf32>) -> tensor<1x256x1024xf32>
