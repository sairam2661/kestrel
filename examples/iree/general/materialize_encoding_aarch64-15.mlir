#executable_target_xyz = #hal.executable.target<"llvm-cpu", "xyz", {cpu_features = "+dotprod,+i8mm", iree.encoding.resolver = #iree_cpu.cpu_encoding_resolver<>, target_triple = "aarch64-xyz-xyz", ukernels = "all"}>
...
#encoding = #iree_encoding.encoding<operand_index = 0 : i64, op_type =  matmul, element_types = [i8, i4, i32], user_indexing_maps = [#map, #map1, #map2], iteration_sizes = [?, ?, ?]>
#encoding1 = #iree_encoding.encoding<operand_index = 1 : i64, op_type =  matmul, element_types = [i8, i4, i32], user_indexing_maps = [#map, #map1, #map2], iteration_sizes = [?, ?, ?]>
#encoding2 = #iree_encoding.encoding<operand_index = 2 : i64, op_type =  matmul, element_types = [i8, i4, i32], user_indexing_maps = [#map, #map1, #map2], iteration_sizes = [?, ?, ?]>
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "matmul_lowering_i8i4i32_aarch64_i8mm"}> ({
    ...
    ^bb0(%arg0: i8, %arg1: i4, %arg2: i32):
      %11 = "arith.extsi"(%arg0) : (i8) -> i32
      %12 = "arith.extsi"(%arg1) : (i4) -> i32
      ...
      "linalg.yield"(%14) : (i32) -> ()
    }) : (tensor<?x?xi8, #encoding>, tensor<?x?xi4, #encoding1>, tensor<?x?xi32, #encoding2>) -> tensor<?x?xi32, #encoding2>
