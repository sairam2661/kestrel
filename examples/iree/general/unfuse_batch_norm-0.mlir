"builtin.module"() ({
  "func.func"() <{function_type = (tensor<4x256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>) -> tensor<4x256xf32>, sym_name = "batchNormInference_2D_inner_features"}> ({
