...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "matvec_unit_n_dim"}> ({
    ...
    %4 = "hal.interface.binding.subspan"(%0) <{alignment = 64 : index, binding = 2 : index, layout = #pipeline_layout, operandSegmentSizes = array<i32: 1, 0>}> : (index) -> !iree_tensor_ext.dispatch.tensor<writeonly:tensor<32000x1xf16>>
    ...
    %7 = "tensor.empty"() : () -> tensor<32000x1xf16>
    %8 = "linalg.fill"(%1, %7) <{operandSegmentSizes = array<i32: 1, 1>}> ({
    ^bb0(%arg3: f16, %arg4: f16):
      "linalg.yield"(%arg3) : (f16) -> ()
    }) : (f16, tensor<32000x1xf16>) -> tensor<32000x1xf16>
    %9 = "linalg.generic"(%6, %5, %8) <{indexing_maps = [#map, #map1, #map2], iterator_types = [#linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>, #linalg.iterator_type<reduction>], operandSegmentSizes = array<i32: 2, 1>}> ({
    ^bb0(%arg0: f16, %arg1: f16, %arg2: f16):
      ...
      "linalg.yield"(%11) : (f16) -> ()
    }) : (tensor<32000x4096xf16>, tensor<1x4096xf16>, tensor<32000x1xf16>) -> tensor<32000x1xf16>
    "iree_tensor_ext.dispatch.tensor.store"(%9, %4) <{operandSegmentSizes = array<i32: 1, 1, 0, 0, 0, 0>, static_offsets = array<i64: 0, 0>, static_sizes = array<i64: 32000, 1>, static_strides = array<i64: 1, 1>}> : (tensor<32000x1xf16>, !iree_tensor_ext.dispatch.tensor<writeonly:tensor<32000x1xf16>>) -> ()
    "func.return"() : () -> ()
