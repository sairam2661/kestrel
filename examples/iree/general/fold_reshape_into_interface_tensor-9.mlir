...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<4x8x4x128xf32>) -> (), sym_name = "fold_collapse_into_stores_slice_3d"}> ({
  ^bb0(%arg0: tensor<4x8x4x128xf32>):
    ...
    "iree_tensor_ext.dispatch.tensor.store"(%2, %1) <{operandSegmentSizes = array<i32: 1, 1, 0, 0, 0, 0>, static_offsets = array<i64: 0, 1024>, static_sizes = array<i64: 4, 4096>, static_strides = array<i64: 1, 1>}> : (tensor<4x4096xf32>, !iree_tensor_ext.dispatch.tensor<writeonly:tensor<4x4608xf32>>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
