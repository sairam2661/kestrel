...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "fold_reshape_load"}> ({
    ...
    %4 = "hal.interface.binding.subspan"() <{binding = 0 : index, layout = #pipeline_layout, operandSegmentSizes = array<i32: 0, 0>}> : () -> !iree_tensor_ext.dispatch.tensor<writeonly:tensor<3x3x96xf32>>
    ...
    %6 = "tensor.collapse_shape"(%5) <{reassociation = [[0, 1, 2, 3]]}> : (tensor<3x3x1x96xf32>) -> tensor<864xf32>
    %7 = "tensor.expand_shape"(%6) <{reassociation = [[0, 1, 2]], static_output_shape = array<i64: 3, 3, 96>}> : (tensor<864xf32>) -> tensor<3x3x96xf32>
    %8 = "linalg.fill"(%2, %7) <{operandSegmentSizes = array<i32: 1, 1>}> ({
    ^bb0(%arg0: f32, %arg1: f32):
      "linalg.yield"(%arg0) : (f32) -> ()
    }) : (f32, tensor<3x3x96xf32>) -> tensor<3x3x96xf32>
    "iree_tensor_ext.dispatch.tensor.store"(%8, %4, %0, %0, %0, %1, %1, %1) <{operandSegmentSizes = array<i32: 1, 1, 0, 3, 0, 3>, static_offsets = array<i64: -9223372036854775808, -9223372036854775808, -9223372036854775808>, static_sizes = array<i64: 3, 3, 96>, static_strides = array<i64: -9223372036854775808, -9223372036854775808, -9223372036854775808>}> : (tensor<3x3x96xf32>, !iree_tensor_ext.dispatch.tensor<writeonly:tensor<3x3x96xf32>>, index, index, index, index, index, index) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
