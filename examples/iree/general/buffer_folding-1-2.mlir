"builtin.module"() ({
  ...
  ^bb0(%arg0: !hal.buffer, %arg1: index, %arg2: index):
    %0 = "hal_inline.buffer.subspan"(%arg0, %arg1, %arg2) : (!hal.buffer, index, index) -> !hal.buffer
    ...
    %6 = "hal_inline.buffer_view.create"(%0, %1, %2, %4, %5, %3) : (!hal.buffer, index, index, i32, i32, index) -> !hal.buffer_view
