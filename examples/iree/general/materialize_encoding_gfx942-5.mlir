...
#encoding = #iree_encoding.encoding<operand_index = 1 : i64, op_type =  matmul, element_types = [f32, f32, f32], user_indexing_maps = [#map, #map1, #map2], iteration_sizes = [255, 513, ?]>
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "set_encoding_RHS_narrow_unroll8x1x4_MFMA_F32_16x16x4_F32"}> ({
