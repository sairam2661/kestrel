...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<10x20xf16>, tensor<4x20xf16>, tensor<10x4xf16>) -> tensor<10x4xf16>, sym_name = "skip_skinny_n_mmtb"}> ({
  ^bb0(%arg0: tensor<10x20xf16>, %arg1: tensor<4x20xf16>, %arg2: tensor<10x4xf16>):
    ...
    ^bb0(%arg3: f16, %arg4: f16, %arg5: f16):
      ...
      "linalg.yield"(%2) : (f16) -> ()
    }) : (tensor<10x20xf16>, tensor<4x20xf16>, tensor<10x4xf16>) -> tensor<10x4xf16>
    "func.return"(%0) : (tensor<10x4xf16>) -> ()
