#executable_target_rocm_hsaco_fb = #hal.executable.target<"rocm", "rocm-hsaco-fb", {some.thing}>
...
"builtin.module"() ({
  ...
  "hal.executable"() <{sym_name = "internal_executable0", sym_visibility = "private"}> ({
    "hal.executable.variant"() <{sym_name = "rocm_hsaco_fb", sym_visibility = "public", target = #executable_target_rocm_hsaco_fb1}> ({
  ...
  "hal.executable"() <{sym_name = "internal_executable1", sym_visibility = "private"}> ({
    "hal.executable.variant"() <{sym_name = "rocm_hsaco_fb", sym_visibility = "public", target = #executable_target_rocm_hsaco_fb1}> ({
      "hal.executable.export"() <{layout = #pipeline_layout, ordinal = 0 : index, sym_name = "export2", sym_visibility = "public"}> ({
      ^bb0(%arg0: !hal.device):
