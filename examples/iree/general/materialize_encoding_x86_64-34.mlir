...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "broadcast_batch"}> ({
    %0 = "arith.constant"() <{value = 0 : index}> : () -> index
    %1 = "arith.constant"() <{value = 0.000000e+00 : f32}> : () -> f32
    %2 = "hal.interface.binding.subspan"(%0) <{alignment = 64 : index, binding = 0 : index, descriptor_flags = 1 : i32, layout = #pipeline_layout, operandSegmentSizes = array<i32: 1, 0>}> : (index) -> !iree_tensor_ext.dispatch.tensor<readonly:tensor<128x64xf32, #encoding>>
    ...
    %4 = "iree_tensor_ext.dispatch.tensor.load"(%2) <{operandSegmentSizes = array<i32: 1, 0, 0, 0, 0>, static_offsets = array<i64: 0, 0>, static_sizes = array<i64: 128, 64>, static_strides = array<i64: 1, 1>}> : (!iree_tensor_ext.dispatch.tensor<readonly:tensor<128x64xf32, #encoding>>) -> tensor<128x64xf32, #encoding>
    ...
    }) : (tensor<128x64xf32, #encoding>, tensor<2x128x64xf32, #encoding1>) -> tensor<2x128x64xf32, #encoding1>
