...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<1x10x32x8x1xf32>, tensor<1x80x32x4x1xf32>, tensor<1x10x80x8x4xf32>) -> tensor<1x10x80x8x4xf32>, sym_name = "batch_mmt4d_with_fill"}> ({
  ^bb0(%arg0: tensor<1x10x32x8x1xf32>, %arg1: tensor<1x80x32x4x1xf32>, %arg2: tensor<1x10x80x8x4xf32>):
    ...
    }) : (f32, tensor<1x10x80x8x4xf32>) -> tensor<1x10x80x8x4xf32>
    ...
    "func.return"(%2) : (tensor<1x10x80x8x4xf32>) -> ()
