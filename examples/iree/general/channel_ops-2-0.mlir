"builtin.module"() ({
  "util.func"() <{function_type = (!hal.device, i64, !util.buffer, !util.buffer, i32, i32) -> !hal.channel, sym_name = "channel_create", sym_visibility = "public", tied_operands = [-1 : index]}> ({
