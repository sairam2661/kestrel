  ...
  "hal.executable"() <{sym_name = "test", sym_visibility = "public"}> ({
    "hal.executable.variant"() <{sym_name = "rocm_hsaco_fb", sym_visibility = "public", target = #executable_target_rocm_hsaco_fb}> ({
      ...
      "builtin.module"() ({
        ...
        "llvm.func"() <{CConv = #llvm.cconv<ccc>, function_type = !llvm.func<void ()>, linkage = #llvm.linkage<external>, sym_name = "test_not_exported", unnamed_addr = 0 : i64, visibility_ = 0 : i64}> ({
          "llvm.return"() : () -> ()
        }) : () -> ()
      }) : () -> ()
