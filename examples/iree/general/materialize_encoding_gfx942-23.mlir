...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "matmul_lowering_MFMA_I32_16x16x32_I8_custom_vgpr_space_bits_32768"}> ({
