#executable_target_xyz = #hal.executable.target<"llvm-cpu", "xyz", {cpu_features = "+dotprod", iree.encoding.resolver = #iree_cpu.cpu_encoding_resolver<>, target_triple = "aarch64-xyz-xyz", ukernels = "all"}>
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "matmul_lowering_i8i4i32_aarch64_dotprod"}> ({
