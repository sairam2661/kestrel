...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (!util.buffer, index, index, index, index, index), sym_name = "resolve_binding_subspan_zero_offset"}> ({
    ...
    %2:6 = "vmvx.get_buffer_descriptor"(%1) : (memref<512x384xf32>) -> (!util.buffer, index, index, index, index, index)
