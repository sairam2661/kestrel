"builtin.module"() ({
  "util.func"() <{function_type = (tensor<?x8x8x3xf32>, tensor<?x8x8x3xf32>) -> (tensor<?x8x8x3xf32>, tensor<?x8x8x3xf32>), sym_name = "dynamicEntry", sym_visibility = "public", tied_operands = [-1 : index, -1 : index]}> ({
