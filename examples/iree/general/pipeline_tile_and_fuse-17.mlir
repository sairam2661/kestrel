...
"builtin.module"() ({
  "hal.executable"() <{sym_name = "main", sym_visibility = "public"}> ({
    "hal.executable.variant"() <{sym_name = "rocm_hsaco_fb", sym_visibility = "public", target = #executable_target_rocm_hsaco_fb}> ({
      ...
      "builtin.module"() ({
        "func.func"() <{function_type = () -> (), sym_name = "unaligned_to_intrinsic_batched_matmul_nocpromo"}> ({
          ...
          ^bb0(%arg0: f32, %arg1: f32, %arg2: f32):
            ...
            "linalg.yield"(%11) : (f32) -> ()
          }) {lowering_config = #iree_gpu.lowering_config<{mma_kind = #iree_gpu.mma_layout<MFMA_F32_16x16x4_F32>, padding = [1, 16, 64, 4], promote_operands = [0, 1], reduction = [0, 0, 0, 1], subgroup = [0, 1, 1, 0], workgroup = [1, 16, 64, 0]}>} : (tensor<12x577x577xf32>, tensor<12x577x577xf32>, tensor<12x577x577xf32>) -> tensor<12x577x577xf32>
