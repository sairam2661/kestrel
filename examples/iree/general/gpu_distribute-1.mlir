...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "add_tensor_lane_id"}> ({
    ...
    "scf.forall"(%1) <{mapping = [#iree_gpu.lane_id<0>], operandSegmentSizes = array<i32: 0, 1, 0, 0>, staticLowerBound = array<i64: 0>, staticStep = array<i64: 1>, staticUpperBound = array<i64: -9223372036854775808>}> ({
    ^bb0(%arg0: index):
