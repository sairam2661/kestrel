"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "tensor_float"}> ({
    ...
    %5 = "tosa.greater_equal"(%3, %4) : (tensor<4xf32>, tensor<4xf32>) -> tensor<4xi1>
    "check.expect_eq_const"(%5) <{value = dense<[false, false, true, true]> : tensor<4xi1>}> : (tensor<4xi1>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> (), sym_name = "tensor_int"}> ({
    ...
    %2 = "tosa.greater_equal"(%0, %1) : (tensor<4xi32>, tensor<4xi32>) -> tensor<4xi1>
