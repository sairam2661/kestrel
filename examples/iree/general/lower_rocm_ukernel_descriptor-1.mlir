...
#map1 = affine_map<(d0) -> ()>
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<?xf32>, tensor<f32>, tensor<i64>) -> (tensor<f32>, tensor<i64>), sym_name = "argmax_ukernel_test_with_provider"}> ({
  ^bb0(%arg0: tensor<?xf32>, %arg1: tensor<f32>, %arg2: tensor<i64>):
    ...
    "func.return"(%1#0, %1#1) : (tensor<f32>, tensor<i64>) -> ()
  }) : () -> ()
