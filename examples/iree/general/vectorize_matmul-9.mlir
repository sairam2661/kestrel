...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<4x16xi8>, tensor<16x4xi8>) -> tensor<4x4xi32>, sym_name = "matmul_4x16x4_i8_to_i32_dot_prod"}> ({
  ^bb0(%arg0: tensor<4x16xi8>, %arg1: tensor<16x4xi8>):
    ...
    ^bb0(%arg2: i8, %arg3: i8, %arg4: i32):
      ...
      "linalg.yield"(%8) : (i32) -> ()
    }) : (tensor<4x16xi8>, tensor<16x4xi8>, tensor<4x4xi32>) -> tensor<4x4xi32>
