#executable_target_vmvx_bytecode_fb = #hal.executable.target<"vmvx", "vmvx-bytecode-fb", {iree.encoding.resolver = #iree_cpu.vmvx_encoding_resolver<>, ukernels = "all"}>
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "matmul_lowering_i8i8i32_vmvx_ukernel"}> ({
