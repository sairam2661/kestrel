...
"builtin.module"() ({
  "hal.executable"() <{sym_name = "main", sym_visibility = "public"}> ({
    "hal.executable.variant"() <{sym_name = "rocm_hsaco_fb", sym_visibility = "public", target = #executable_target_rocm_hsaco_fb}> ({
      "hal.executable.export"() <{layout = #pipeline_layout, ordinal = 0 : index, sym_name = "matmul_transpose_b_wmmar3_f16_16x16x16_f16", sym_visibility = "public"}> ({
      ^bb0(%arg5: !hal.device):
      ...
      "builtin.module"() ({
        "func.func"() <{function_type = () -> (), sym_name = "matmul_transpose_b_wmmar3_f16_16x16x16_f16"}> ({
          ...
          %4 = "hal.interface.binding.subspan"(%1) <{alignment = 64 : index, binding = 2 : index, layout = #pipeline_layout, operandSegmentSizes = array<i32: 1, 0>}> : (index) -> !iree_tensor_ext.dispatch.tensor<writeonly:tensor<2048x10240xf16>>
          ...
          %7 = "tensor.empty"() : () -> tensor<2048x10240xf16>
          %8 = "linalg.fill"(%0, %7) <{operandSegmentSizes = array<i32: 1, 1>}> ({
          ^bb0(%arg3: f16, %arg4: f16):
            "linalg.yield"(%arg3) : (f16) -> ()
          }) : (f16, tensor<2048x10240xf16>) -> tensor<2048x10240xf16>
          ...
          ^bb0(%arg0: f16, %arg1: f16, %arg2: f16):
            ...
            "linalg.yield"(%11) : (f16) -> ()
          }) {lowering_config = #iree_gpu.lowering_config<{mma_kind = #iree_gpu.mma_layout<WMMAR3_F16_16x16x16_F16>, promote_operands = [0, 1], reduction = [0, 0, 2], subgroup = [2, 2], workgroup = [64, 64, 0]}>} : (tensor<2048x1280xf16>, tensor<10240x1280xf16>, tensor<2048x10240xf16>) -> tensor<2048x10240xf16>
          "iree_tensor_ext.dispatch.tensor.store"(%9, %4) <{operandSegmentSizes = array<i32: 1, 1, 0, 0, 0, 0>, static_offsets = array<i64: 0, 0>, static_sizes = array<i64: 2048, 10240>, static_strides = array<i64: 1, 1>}> : (tensor<2048x10240xf16>, !iree_tensor_ext.dispatch.tensor<writeonly:tensor<2048x10240xf16>>) -> ()
          "func.return"() : () -> ()
