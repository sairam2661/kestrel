...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "slice_whole_stride_dispatch_0"}> ({
    ...
    %7 = "tensor.extract_slice"(%6) <{operandSegmentSizes = array<i32: 1, 0, 0, 0>, static_offsets = array<i64: 1, 0>, static_sizes = array<i64: 1, 4>, static_strides = array<i64: 1, 1>}> : (tensor<?x?xi32>) -> tensor<1x4xi32>
    "iree_tensor_ext.dispatch.tensor.store"(%7, %5, %2, %3) <{operandSegmentSizes = array<i32: 1, 1, 2, 0, 0, 0>, static_offsets = array<i64: 0, 0>, static_sizes = array<i64: 1, 4>, static_strides = array<i64: 1, 1>}> : (tensor<1x4xi32>, !iree_tensor_ext.dispatch.tensor<writeonly:tensor<?x?xi32>>, index, index) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
