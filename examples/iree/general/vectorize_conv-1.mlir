...
#map = affine_map<(d0, d1, d2, d3, d4) -> (d0, d1 * 2 + d3, d4)>
#map1 = affine_map<(d0, d1, d2, d3, d4) -> (d3, d4, d2)>
#map2 = affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2)>
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<1x7x3xi8>, tensor<1x3x4xi8>) -> tensor<1x4x4xi32>, sym_name = "nwc_conv_1d_dot_prod"}> ({
  ^bb0(%arg0: tensor<1x7x3xi8>, %arg1: tensor<1x3x4xi8>):
    %0 = "arith.constant"() <{value = 0 : i32}> : () -> i32
    %1 = "arith.constant"() <{value = 0 : index}> : () -> index
    %2 = "tensor.empty"() : () -> tensor<1x4x4xi32>
    %3 = "linalg.fill"(%0, %2) <{operandSegmentSizes = array<i32: 1, 1>}> ({
    ^bb0(%arg5: i32, %arg6: i32):
      "linalg.yield"(%arg5) : (i32) -> ()
    }) : (i32, tensor<1x4x4xi32>) -> tensor<1x4x4xi32>
    %4 = "linalg.conv_1d_nwc_wcf"(%arg0, %arg1, %3) <{dilations = dense<1> : vector<1xi64>, operandSegmentSizes = array<i32: 2, 1>, strides = dense<2> : vector<1xi64>}> ({
    ^bb0(%arg2: i8, %arg3: i8, %arg4: i32):
      ...
      "linalg.yield"(%8) : (i32) -> ()
    }) {linalg.memoized_indexing_maps = [#map, #map1, #map2]} : (tensor<1x7x3xi8>, tensor<1x3x4xi8>, tensor<1x4x4xi32>) -> tensor<1x4x4xi32>
    "func.return"(%4) : (tensor<1x4x4xi32>) -> ()
