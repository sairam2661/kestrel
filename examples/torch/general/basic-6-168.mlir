"builtin.module"() ({
  ...
  ^bb0(%arg0: !torch.vtensor<[1,1,56,56],f32>):
    ...
    %12 = "torch.aten.avg_pool2d"(%arg0, %2, %5, %8, %9, %10, %11) : (!torch.vtensor<[1,1,56,56],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool, !torch.bool, !torch.none) -> !torch.vtensor<[1,1,27,27],f32>
    "func.return"(%12) : (!torch.vtensor<[1,1,27,27],f32>) -> ()
  }) : () -> ()
}) : () -> ()
