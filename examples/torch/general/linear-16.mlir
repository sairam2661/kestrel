"builtin.module"() ({
  "func.func"() <{function_type = (!torch.vtensor<[1,2,7,7],f32>, !torch.vtensor<[2,4,3,3],f32>) -> !torch.vtensor<[1,4,15,15],f32>, sym_name = "torch.aten.convolution$transposed_stride"}> ({
  ^bb0(%arg0: !torch.vtensor<[1,2,7,7],f32>, %arg1: !torch.vtensor<[2,4,3,3],f32>):
    ...
    %8 = "torch.aten.convolution"(%arg0, %arg1, %1, %7, %5, %6, %0, %5, %3) : (!torch.vtensor<[1,2,7,7],f32>, !torch.vtensor<[2,4,3,3],f32>, !torch.none, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool, !torch.list<int>, !torch.int) -> !torch.vtensor<[1,4,15,15],f32>
