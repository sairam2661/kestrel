"builtin.module"() ({
  "func.func"() <{function_type = (!torch.vtensor<[1,1,112,112],f32>) -> !torch.vtensor<[1,1,56,56],f32>, sym_name = "torch.aten.max_pool2d$full_dim_indivisible_by_stride_without_sliced_input"}> ({
  ^bb0(%arg0: !torch.vtensor<[1,1,112,112],f32>):
    ...
    %13 = "torch.aten.max_pool2d"(%arg0, %2, %5, %8, %11, %12) : (!torch.vtensor<[1,1,112,112],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool) -> !torch.vtensor<[1,1,56,56],f32>
    "func.return"(%13) : (!torch.vtensor<[1,1,56,56],f32>) -> ()
  }) : () -> ()
}) : () -> ()
