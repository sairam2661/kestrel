"builtin.module"() ({
  ...
  ^bb0(%arg0: !torch.vtensor<[1,192,35,35],f32>):
    ...
    %9 = "torch.aten.avg_pool2d"(%arg0, %6, %7, %8, %3, %4, %5) : (!torch.vtensor<[1,192,35,35],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool, !torch.bool, !torch.none) -> !torch.vtensor<[1,192,35,35],f32>
