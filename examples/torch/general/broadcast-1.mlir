"builtin.module"() ({
  ...
  ^bb0(%arg0: !torch.vtensor<[1,1,2],f32>):
    ...
    %4 = "torch.aten.broadcast_to"(%arg0, %3) : (!torch.vtensor<[1,1,2],f32>, !torch.list<int>) -> !torch.vtensor<[1,4,2],f32>
    "func.return"(%4) : (!torch.vtensor<[1,4,2],f32>) -> ()
  }) : () -> ()
}) : () -> ()
