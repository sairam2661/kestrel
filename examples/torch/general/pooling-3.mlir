"builtin.module"() ({
  ...
  ^bb0(%arg0: !torch.vtensor<[1,3,64,56],f32>):
    ...
    %11 = "torch.aten.avg_pool2d"(%arg0, %8, %9, %10, %1, %2, %0) : (!torch.vtensor<[1,3,64,56],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool, !torch.bool, !torch.none) -> !torch.vtensor<[1,3,61,27],f32>
