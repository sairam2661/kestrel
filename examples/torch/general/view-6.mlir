"builtin.module"() ({
  ...
  ^bb0(%arg0: !torch.vtensor<[4,5,6],f32>):
    ...
    %4 = "torch.prim.ListConstruct"(%0, %1, %0, %2, %3) : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %5 = "torch.aten.view"(%arg0, %4) : (!torch.vtensor<[4,5,6],f32>, !torch.list<int>) -> !torch.vtensor<[2,1,2,3,?],f32>
    "func.return"(%5) : (!torch.vtensor<[2,1,2,3,?],f32>) -> ()
