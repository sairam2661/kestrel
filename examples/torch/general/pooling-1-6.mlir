"builtin.module"() ({
  ...
  ^bb0(%arg0: !torch.vtensor<[?,?,?,?],f32>):
    ...
    %8 = "torch.aten.avg_pool2d"(%arg0, %5, %6, %7, %3, %3, %4) : (!torch.vtensor<[?,?,?,?],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool, !torch.bool, !torch.none) -> !torch.vtensor<[?,?,?,?],f32>
