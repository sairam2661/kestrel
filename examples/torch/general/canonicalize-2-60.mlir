"builtin.module"() ({
  ...
  ^bb0(%arg0: !torch.vtensor<[10,64,112,112],f32>):
    ...
    %7:2 = "torch.aten.max_pool2d_with_indices"(%arg0, %4, %5, %6, %6, %0) : (!torch.vtensor<[10,64,112,112],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool) -> (!torch.vtensor<[10,64,56,56],f32>, !torch.vtensor<[10,64,56,56],si64>)
    "func.return"(%7#0) : (!torch.vtensor<[10,64,56,56],f32>) -> ()
  }) : () -> ()
}) : () -> ()
