"builtin.module"() ({
  ...
  ^bb0(%arg0: !torch.vtensor<[1,2,4],f32>):
    ...
    %3 = "torch.aten.reflection_pad1d"(%arg0, %2) : (!torch.vtensor<[1,2,4],f32>, !torch.list<int>) -> !torch.vtensor<[1,2,8],f32>
    "func.return"(%3) : (!torch.vtensor<[1,2,8],f32>) -> ()
  }) : () -> ()
}) : () -> ()
