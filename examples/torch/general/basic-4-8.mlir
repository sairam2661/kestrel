"builtin.module"() ({
  ...
  ^bb0(%arg0: !torch.vtensor<[?,3,?,?],f32>):
    ...
    %5 = "torch.aten.batch_norm"(%arg0, %1, %0, %0, %1, %2, %3, %4, %2) : (!torch.vtensor<[?,3,?,?],f32>, !torch.vtensor<[3],f32>, !torch.vtensor<[3],f32>, !torch.vtensor<[3],f32>, !torch.vtensor<[3],f32>, !torch.bool, !torch.float, !torch.float, !torch.bool) -> !torch.vtensor<[?,3,?,?],f32>
    "func.return"(%5) : (!torch.vtensor<[?,3,?,?],f32>) -> ()
  }) : () -> ()
}) : () -> ()
