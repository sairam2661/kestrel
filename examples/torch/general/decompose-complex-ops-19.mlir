"builtin.module"() ({
  ...
  ^bb0(%arg0: !torch.vtensor<[40],f32>, %arg1: !torch.vtensor<[4],f32>):
    ...
    %6 = "torch.aten.stft.center"(%arg0, %1, %2, %3, %arg1, %4, %0, %4, %4, %5, %4) : (!torch.vtensor<[40],f32>, !torch.int, !torch.int, !torch.int, !torch.vtensor<[4],f32>, !torch.bool, !torch.str, !torch.bool, !torch.bool, !torch.bool, !torch.bool) -> !torch.vtensor<[3,37],complex<f32>>
    "func.return"(%6) : (!torch.vtensor<[3,37],complex<f32>>) -> ()
  }) : () -> ()
}) : () -> ()
