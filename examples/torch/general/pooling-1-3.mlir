"builtin.module"() ({
  ...
  ^bb0(%arg0: !torch.vtensor<[1,256,56,56],f32>):
    ...
    %9 = "torch.aten.max_pool2d"(%arg0, %5, %6, %7, %8, %3) : (!torch.vtensor<[1,256,56,56],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool) -> !torch.vtensor<[1,256,27,27],f32>
    "func.return"(%9) : (!torch.vtensor<[1,256,27,27],f32>) -> ()
  }) : () -> ()
}) : () -> ()
