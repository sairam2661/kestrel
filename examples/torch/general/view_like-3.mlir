"builtin.module"() ({
  ...
  ^bb0(%arg0: !torch.vtensor<[4,65,256],f32>):
    ...
    %3 = "torch.aten.slice.Tensor"(%arg0, %1, %2, %0, %1) : (!torch.vtensor<[4,65,256],f32>, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.vtensor<[4,1,256],f32>
    "func.return"(%3) : (!torch.vtensor<[4,1,256],f32>) -> ()
  }) : () -> ()
}) : () -> ()
