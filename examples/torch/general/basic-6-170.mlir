"builtin.module"() ({
  "func.func"() <{function_type = (!torch.vtensor<[1,1,75,75],f32>) -> !torch.vtensor<[1,1,25,25],f32>, sym_name = "torch.aten.avg_pool2d$full_dim_indivisible_by_stride_with_sliced_input"}> ({
  ^bb0(%arg0: !torch.vtensor<[1,1,75,75],f32>):
    ...
    %12 = "torch.aten.avg_pool2d"(%arg0, %2, %5, %8, %9, %10, %11) : (!torch.vtensor<[1,1,75,75],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool, !torch.bool, !torch.none) -> !torch.vtensor<[1,1,25,25],f32>
    "func.return"(%12) : (!torch.vtensor<[1,1,25,25],f32>) -> ()
  }) : () -> ()
}) : () -> ()
