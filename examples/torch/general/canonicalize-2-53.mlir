"builtin.module"() ({
  "func.func"() <{function_type = () -> (!torch.vtensor<[4],i1>, !torch.vtensor<[4],i1>, !torch.vtensor<[4],i1>), sym_name = "aten_tensor_tensor_eq"}> ({
    ...
    %5 = "torch.aten.eq.Scalar"(%0, %3) : (!torch.vtensor<[4],si8>, !torch.int) -> !torch.vtensor<[4],i1>
    %6 = "torch.aten.eq.Scalar"(%1, %3) : (!torch.vtensor<[4],ui8>, !torch.int) -> !torch.vtensor<[4],i1>
    %7 = "torch.aten.eq.Scalar"(%2, %4) : (!torch.vtensor<[4],f32>, !torch.float) -> !torch.vtensor<[4],i1>
