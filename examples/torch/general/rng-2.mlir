"builtin.module"() ({
  "func.func"() <{function_type = () -> !torch.vtensor<[32,64],f64>, sym_name = "torch.aten.randn.generator"}> ({
    ...
    %4 = "torch.aten.randn.generator"(%3, %0, %0, %0, %0, %0) : (!torch.list<int>, !torch.none, !torch.none, !torch.none, !torch.none, !torch.none) -> !torch.vtensor<[32,64],f64>
    "func.return"(%4) : (!torch.vtensor<[32,64],f64>) -> ()
  }) : () -> ()
}) : () -> ()
