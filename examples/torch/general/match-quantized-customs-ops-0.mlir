"builtin.module"() ({
  ...
  ^bb0(%arg0: !torch.vtensor<[1,3,8,8],f32>):
    ...
    %5 = "torch.operator"(%arg0, %0, %1, %2, %3, %4) <{name = "torch.quantized_decomposed.quantize_per_tensor"}> : (!torch.vtensor<[1,3,8,8],f32>, !torch.float, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.vtensor<[1,3,8,8],si8>
    "func.return"(%5) : (!torch.vtensor<[1,3,8,8],si8>) -> ()
  }) : () -> ()
}) : () -> ()
