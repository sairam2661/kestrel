"builtin.module"() ({
  ...
  ^bb0(%arg0: !torch.vtensor<[1,3,7,64,56],f32>):
    ...
    %11 = "torch.aten.avg_pool3d"(%arg0, %8, %9, %10, %1, %1, %0) : (!torch.vtensor<[1,3,7,64,56],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool, !torch.bool, !torch.none) -> !torch.vtensor<[1,3,4,31,54],f32>
