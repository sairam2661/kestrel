"builtin.module"() ({
  "func.func"() <{function_type = () -> !torch.vtensor<[4],i1>, sym_name = "aten_eq_tensor_splats_fp_false"}> ({
    %0 = "torch.vtensor.literal"() <{value = dense<4.000000e+00> : tensor<4xf32>}> : () -> !torch.vtensor<[4],f32>
    %1 = "torch.vtensor.literal"() <{value = dense<5.000000e+00> : tensor<4xf32>}> : () -> !torch.vtensor<[4],f32>
