"builtin.module"() ({
  ...
  ^bb0(%arg0: i16):
    ...
    %7 = "arith.muli"(%6, %arg0) <{overflowFlags = #arith.overflow<none>}> : (i16, i16) -> i16
    %8 = "arith.muli"(%7, %arg0) <{overflowFlags = #arith.overflow<none>}> : (i16, i16) -> i16
    %9 = "arith.muli"(%8, %arg0) <{overflowFlags = #arith.overflow<none>}> : (i16, i16) -> i16
    %10 = "arith.muli"(%9, %arg0) <{overflowFlags = #arith.overflow<none>}> : (i16, i16) -> i16
    %11 = "arith.muli"(%10, %arg0) <{overflowFlags = #arith.overflow<none>}> : (i16, i16) -> i16
    %12 = "arith.muli"(%11, %arg0) <{overflowFlags = #arith.overflow<none>}> : (i16, i16) -> i16
    %13 = "arith.muli"(%12, %arg0) <{overflowFlags = #arith.overflow<none>}> : (i16, i16) -> i16
    %14 = "arith.muli"(%13, %arg0) <{overflowFlags = #arith.overflow<none>}> : (i16, i16) -> i16
    "func.return"(%6) : (i16) -> ()
  }) : () -> ()
}) : () -> ()
