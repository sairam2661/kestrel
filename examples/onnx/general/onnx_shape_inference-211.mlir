"builtin.module"() ({
  "func.func"() <{function_type = (tensor<3x4x5x6xf32>) -> tensor<*xf32>, sym_name = "test_resize_scales_floor"}> ({
  ^bb0(%arg0: tensor<3x4x5x6xf32>):
    ...
    %2 = "onnx.Constant"() {value = dense<[1.000000e+00, 1.000000e+00, 2.000000e+00, 1.510000e+00]> : tensor<4xf32>} : () -> tensor<4xf32>
