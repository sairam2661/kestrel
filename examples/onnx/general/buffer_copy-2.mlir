"builtin.module"() ({
  "func.func"() <{function_type = (index, index) -> (), sym_name = "copy_to_larger_source", sym_visibility = "private"}> ({
  ^bb0(%arg0: index, %arg1: index):
    ...
    "krnl.copy_to_tile_buffer"(%1, %0, %3, %4, %5, %6, %2) {transpose = false} : (memref<4x6xf32>, memref<5x10x40x60xf32>, index, index, index, index, f32) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
