"builtin.module"() ({
  "func.func"() <{function_type = (tensor<?xi64>) -> tensor<2x?xf32>, sym_name = "test_replace_mul_by_expand_2"}> ({
  ^bb0(%arg0: tensor<?xi64>):
    ...
    %5 = "onnx.Constant"() {value = dense<2.000000e+00> : tensor<f32>} : () -> tensor<f32>
