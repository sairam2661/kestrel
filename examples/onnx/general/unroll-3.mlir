...
#map2 = affine_map<() -> (20)>
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "unroll_with_block_and_permute"}> ({
    ...
    ^bb0(%arg0: index, %arg1: index):
      ...
      "krnl.iterate"(%1#1, %2#1) ({
        %4:2 = "krnl.get_induction_var_value"(%1#1, %2#1) : (!krnl.loop, !krnl.loop) -> (index, index)
        %5 = "arith.addi"(%4#0, %4#1) : (index, index) -> index
        %6 = "arith.addi"(%3#0, %4#1) : (index, index) -> index
        "krnl.terminate"() : () -> ()
