"builtin.module"() ({
  "func.func"() <{function_type = (tensor<1x104x128x104xf16, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x104x128x104xf16, #zhigh.layout<{dataLayout = "NHWC"}>>, sym_name = "replace_leakyrelu_2"}> ({
  ^bb0(%arg0: tensor<1x104x128x104xf16, #zhigh.layout<{dataLayout = "NHWC"}>>):
    ...
    "func.return"(%2) : (tensor<1x104x128x104xf16, #zhigh.layout<{dataLayout = "NHWC"}>>) -> ()
  }) : () -> ()
}) : () -> ()
