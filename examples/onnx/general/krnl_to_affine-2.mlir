...
#map1 = affine_map<() -> (10)>
"builtin.module"() ({
  "func.func"() <{function_type = (memref<10x10xf32>, memref<10x?xf32>) -> memref<10x10xf32>, sym_name = "test_krnl_load_with_krnl_iterate"}> ({
  ^bb0(%arg0: memref<10x10xf32>, %arg1: memref<10x?xf32>):
    ...
    ^bb0(%arg2: index, %arg3: index):
      ...
      "krnl.store"(%9, %0, %arg2, %arg3) : (f32, memref<10x10xf32>, index, index) -> ()
      "krnl.terminate"() : () -> ()
