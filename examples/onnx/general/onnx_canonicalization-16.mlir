"builtin.module"() ({
  "func.func"() <{function_type = (tensor<3x5x10x20xf32>, tensor<20x1xf32>) -> tensor<3x5x10x1xf32>, sym_name = "test_reshape_removal_with_matmul_4D"}> ({
  ^bb0(%arg0: tensor<3x5x10x20xf32>, %arg1: tensor<20x1xf32>):
    ...
    %4 = "onnx.Reshape"(%3, %1) {allowzero = 0 : si64} : (tensor<150x1xf32>, tensor<4xi64>) -> tensor<3x5x10x1xf32>
    "onnx.Return"(%4) : (tensor<3x5x10x1xf32>) -> ()
  }) : () -> ()
}) : () -> ()
