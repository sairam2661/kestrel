"builtin.module"() ({
  "func.func"() <{function_type = (tensor<2x4xf32>) -> tensor<*xf32>, sym_name = "test_slice_constant_default_steps"}> ({
  ^bb0(%arg0: tensor<2x4xf32>):
    ...
    %4 = "onnx.Slice"(%arg0, %1, %2, %0, %3) : (tensor<2x4xf32>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, none) -> tensor<*xf32>
