"builtin.module"() ({
  "func.func"() <{function_type = () -> (tensor<12xf8E5M2>, tensor<12xf8E5M2>), sym_name = "test_cast_f32_f8E5M2"}> ({
    ...
    %1 = "onnx.Cast"(%0) {saturate = 0 : si64, to = f8E5M2} : (tensor<12xf32>) -> tensor<12xf8E5M2>
    %2 = "onnx.Cast"(%0) {saturate = 1 : si64, to = f8E5M2} : (tensor<12xf32>) -> tensor<12xf8E5M2>
