"builtin.module"() ({
  "func.func"() <{function_type = (tensor<?x256xi64>, tensor<?x256xi64>) -> tensor<?x?x?xi64>, sym_name = "test_update_reshape_output_shape"}> ({
  ^bb0(%arg0: tensor<?x256xi64>, %arg1: tensor<?x256xi64>):
    ...
    %4 = "onnx.Reshape"(%arg1, %3) {allowzero = 0 : si64} : (tensor<?x256xi64>, tensor<3xi64>) -> tensor<?x?x?xi64>
