"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "test_call_zdnn_avgpool2d"}> ({
    ...
    "zlow.avgpool2d"(%0, %2, %1) {kernel_shape = [5, 5], padding_type = "SAME_PADDING", strides = [2, 2]} : (memref<2048xf16>, memref<6xi64>, memref<2048xf16>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
