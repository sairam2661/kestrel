"builtin.module"() ({
  "func.func"() <{function_type = (tensor<4x3xi8>) -> tensor<4x2xi32>, sym_name = "test_matmulinteger_rhs_zero_none"}> ({
  ^bb0(%arg0: tensor<4x3xi8>):
    %0 = "onnx.Constant"() {value = dense<0> : tensor<3x2xui8>} : () -> tensor<3x2xui8>
