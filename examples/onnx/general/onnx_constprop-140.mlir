"builtin.module"() ({
  "func.func"() <{function_type = (tensor<*xf16>, tensor<1xi64>, tensor<*xf16>) -> tensor<?xi64>, sym_name = "test_if_false"}> ({
  ^bb0(%arg0: tensor<*xf16>, %arg1: tensor<1xi64>, %arg2: tensor<*xf16>):
    %0 = "onnx.Constant"() {value = dense<false> : tensor<1xi1>} : () -> tensor<1xi1>
    %1 = "onnx.If"(%0) ({
