"builtin.module"() ({
  "func.func"() <{function_type = (tensor<1x1x28x28xf32>, tensor<8x1x5x5xf32>, tensor<8xf32>) -> tensor<1x8x28x28xf32>, sym_name = "test_fuse_add_conv_bias"}> ({
  ^bb0(%arg0: tensor<1x1x28x28xf32>, %arg1: tensor<8x1x5x5xf32>, %arg2: tensor<8xf32>):
