"builtin.module"() ({
  "func.func"() <{function_type = (tensor<?x20xf32>, tensor<?x30xf32>) -> (tensor<2xi64>, tensor<50x?xf32>), sym_name = "test_concatfuse_1"}> ({
  ^bb0(%arg0: tensor<?x20xf32>, %arg1: tensor<?x30xf32>):
    ...
    %3 = "onnx.Sin"(%0) : (tensor<?x50xf32>) -> tensor<?x50xf32>
