"builtin.module"() ({
  "func.func"() <{function_type = (tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<3x?x?xi64>, sym_name = "compute_slice_all_dyn"}> ({
  ^bb0(%arg0: tensor<2xi64>, %arg1: tensor<2xi64>, %arg2: tensor<2xi64>):
    ...
    %2 = "onnx.Slice"(%0, %arg0, %arg1, %1, %arg2) : (tensor<3x4x5xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>, tensor<2xi64>) -> tensor<3x?x?xi64>
    "func.return"(%2) : (tensor<3x?x?xi64>) -> ()
  }) : () -> ()
}) : () -> ()
