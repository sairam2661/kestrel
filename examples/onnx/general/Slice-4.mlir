"builtin.module"() ({
  "func.func"() <{function_type = (tensor<2x4xf32>) -> tensor<*xf32>, sym_name = "test_slice_all_constant_end_outofbound"}> ({
  ^bb0(%arg0: tensor<2x4xf32>):
    ...
    %2 = "onnx.Constant"() {value = dense<[5, 3]> : tensor<2xi64>} : () -> tensor<2xi64>
