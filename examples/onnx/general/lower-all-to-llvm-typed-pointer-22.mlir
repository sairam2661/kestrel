"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "test_call_zdnn_cond2d"}> ({
    ...
    "zlow.conv2d"(%0, %1, %2, %4, %3) {act_func = "ACT_NONE", kernel_shape = [5, 5], padding_type = "SAME_PADDING", strides = [2, 2]} : (memref<2048xf16>, memref<2048xf16>, memref<2048xf16>, memref<7xi64>, memref<2048xf16>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
