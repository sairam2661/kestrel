"builtin.module"() ({
  "func.func"() <{function_type = () -> tensor<10x10xf32>, sym_name = "test_sub"}> ({
    ...
    %4 = "zhigh.Sub"(%2, %3) : (tensor<10x10xf16, #zhigh.layout<{dataLayout = "2D"}>>, tensor<10x10xf16, #zhigh.layout<{dataLayout = "2D"}>>) -> tensor<10x10xf16, #zhigh.layout<{dataLayout = "2D"}>>
