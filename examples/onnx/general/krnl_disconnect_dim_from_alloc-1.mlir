...
"builtin.module"() ({
  "func.func"() <{function_type = (memref<?x?xf32>) -> index, sym_name = "test_krnl_dim_lowering_with_map"}> ({
  ^bb0(%arg0: memref<?x?xf32>):
    ...
    %4 = "krnl.dim"(%3, %1) : (memref<?x10xf32, #map>, index) -> index
    %5 = "krnl.dim"(%3, %0) : (memref<?x10xf32, #map>, index) -> index
