"builtin.module"() ({
  "func.func"() <{function_type = (tensor<1x1x28x28xf32>) -> tensor<*xf32>, sym_name = "test_fuse_mul_conv"}> ({
  ^bb0(%arg0: tensor<1x1x28x28xf32>):
    ...
    %2 = "onnx.Conv"(%arg0, %0, %1) {auto_pad = "NOTSET", group = 1 : si64, kernel_shape = [2, 2], strides = [1, 1]} : (tensor<1x1x28x28xf32>, tensor<8x1x2x2xf32>, none) -> tensor<*xf32>
