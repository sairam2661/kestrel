...
#map4 = affine_map<() -> (5)>
"builtin.module"() ({
  "func.func"() <{function_type = (memref<5x10xf16, #map>) -> memref<10x5xf16, #map>, sym_name = "should_not_rewrite_unstick_transpose_stick_1"}> ({
  ^bb0(%arg0: memref<5x10xf16, #map>):
    ...
    "zlow.stick"(%1, %2) {layout = "2DS"} : (memref<10x5xf32>, memref<10x5xf16, #map>) -> ()
