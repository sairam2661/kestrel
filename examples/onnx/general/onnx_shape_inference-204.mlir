"builtin.module"() ({
  "func.func"() <{function_type = (tensor<2xf32>, tensor<*xf32>) -> (tensor<*xf32>, tensor<*xf32>), sym_name = "test_scan_simple_unranked_main_graph"}> ({
  ^bb0(%arg0: tensor<2xf32>, %arg1: tensor<*xf32>):
