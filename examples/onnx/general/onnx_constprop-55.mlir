"builtin.module"() ({
  "func.func"() <{function_type = (tensor<3x4xui8>) -> tensor<2x4xi32>, sym_name = "test_matmulinteger_lhs_matrix"}> ({
  ^bb0(%arg0: tensor<3x4xui8>):
    %0 = "onnx.Constant"() {value = dense<[[7, 7, 7], [9, 9, 9]]> : tensor<2x3xui8>} : () -> tensor<2x3xui8>
    %1 = "onnx.Constant"() {value = dense<[[7], [9]]> : tensor<2x1xui8>} : () -> tensor<2x1xui8>
