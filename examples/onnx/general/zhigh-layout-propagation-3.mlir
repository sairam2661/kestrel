"builtin.module"() ({
  "func.func"() <{function_type = (tensor<1x56x56x256xf16, #zhigh.layout<{dataLayout = "NHWC"}>>, tensor<1x256x56x56xf32>) -> tensor<1x256x56x56xf16, #zhigh.layout<{dataLayout = "4D"}>>, sym_name = "sub_layout_propagate_nhwc_2"}> ({
