"builtin.module"() ({
  "func.func"() <{function_type = (tensor<?x?x768xf32>, tensor<?x?x768xf32>) -> tensor<?x12x?x?xf32>, sym_name = "test_mul_in_attention"}> ({
  ^bb0(%arg0: tensor<?x?x768xf32>, %arg1: tensor<?x?x768xf32>):
    ...
    %19 = "onnx.Constant"() {value = dense<1.250000e-01> : tensor<f32>} : () -> tensor<f32>
