"builtin.module"() ({
  "func.func"() <{function_type = (tensor<2x4xf32>) -> tensor<*xf32>, sym_name = "test_slice_all_constant_negative_steps"}> ({
  ^bb0(%arg0: tensor<2x4xf32>):
    ...
    %2 = "onnx.Constant"() {value = dense<[2, 0]> : tensor<2xi64>} : () -> tensor<2xi64>
