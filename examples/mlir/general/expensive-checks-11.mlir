"builtin.module"() ({
  ...
  "builtin.module"() ({
    ...
    ^bb0(%arg0: !transform.any_op):
      ...
      %2 = "transform.structured.match"(%arg0) <{ops = ["test.match_anchor_2"]}> : (!transform.any_op) -> !transform.any_op
      %3 = "transform.test_produce_value_handle_to_result"(%1) <{number = 0 : i64}> : (!transform.any_op) -> !transform.any_value
