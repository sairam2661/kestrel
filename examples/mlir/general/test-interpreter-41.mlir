"builtin.module"() ({
  ...
  ^bb0(%arg1: index, %arg2: index, %arg3: index):
    %4 = "arith.muli"(%arg1, %arg2) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
    %5 = "arith.muli"(%arg1, %arg3) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
    %6 = "arith.muli"(%arg1, %arg3) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
    %7 = "arith.muli"(%arg1, %arg3) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
    "func.return"() : () -> ()
  }) : () -> ()
  "builtin.module"() ({
    ...
    ^bb0(%arg0: !transform.any_op):
      ...
      %1:2 = "transform.split_handle"(%0) <{fail_on_payload_too_small = true, overflow_result = 0 : i64, pass_through_empty_handle = true}> : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
