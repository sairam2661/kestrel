module {
  func.func private @loop_unroll_and_jam_unsupported_dynamic_trip_count(%arg0: memref<96x128xi8, 3>, %arg1: memref<128xi8, 3>) {
    ...
    scf.for %arg2 = %c0 to %c4 step %c1 {
      scf.for %arg3 = %c0 to %c128 step %arg2 {
        %0 = memref.load %arg1[%arg3] : memref<128xi8, 3>
        %1 = scf.for %arg4 = %c0 to %c96 step %c1 iter_args(%arg5 = %0) -> (i8) {
          %2 = memref.load %arg0[%arg4, %arg3] : memref<96x128xi8, 3>
          %3 = arith.addi %2, %0 : i8
          scf.yield %3 : i8
        }
        memref.store %1, %arg1[%arg3] : memref<128xi8, 3>
      }
    }
    return
  }
