"builtin.module"() ({
  ...
  ^bb0(%arg0: tensor<13x21x3xi32>, %arg1: tensor<1xi32>):
    ...
    %2 = "tosa.rescale"(%arg0, %arg1, %1, %0, %0) <{input_unsigned = false, output_unsigned = false, per_channel = false, rounding_mode = "SINGLE_ROUND", scale32 = true}> : (tensor<13x21x3xi32>, tensor<1xi32>, tensor<1xi8>, tensor<1xi32>, tensor<1xi32>) -> tensor<13x21x3xi32>
