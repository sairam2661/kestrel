"builtin.module"() ({
  ...
  ^bb0(%arg0: tensor<2xi8>):
    ...
    %4 = "tosa.rescale"(%arg0, %0, %1, %2, %3) <{input_unsigned = false, output_unsigned = false, per_channel = false, rounding_mode = "INEXACT_ROUND", scale32 = true}> {input_zp = 243 : i32, output_zp = 252 : i32} : (tensor<2xi8>, tensor<1xi32>, tensor<1xi8>, tensor<1xi8>, tensor<1xi8>) -> tensor<2xi8>
