"builtin.module"() ({
  ...
  ^bb0(%arg0: tensor<4xi32>, %arg1: tensor<1xi32>):
    ...
    %9 = "tosa.maximum"(%arg0, %arg1) <{nan_mode = "PROPAGATE"}> : (tensor<4xi32>, tensor<1xi32>) -> tensor<*xi32>
    %10 = "tosa.minimum"(%arg0, %arg1) <{nan_mode = "PROPAGATE"}> : (tensor<4xi32>, tensor<1xi32>) -> tensor<*xi32>
