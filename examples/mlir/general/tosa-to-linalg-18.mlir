"builtin.module"() ({
  ...
  ^bb0(%arg0: tensor<1xi32>, %arg1: tensor<1xui32>, %arg2: tensor<1xui64>):
    ...
    %21 = "tosa.maximum"(%0, %1) <{nan_mode = "PROPAGATE"}> : (tensor<1xi32>, tensor<1xi32>) -> tensor<1xi32>
    %22 = "tosa.minimum"(%0, %1) <{nan_mode = "PROPAGATE"}> : (tensor<1xi32>, tensor<1xi32>) -> tensor<1xi32>
    %23 = "tosa.clamp"(%0) <{max_val = 5 : i32, min_val = 1 : i32, nan_mode = "PROPAGATE"}> : (tensor<1xi32>) -> tensor<1xi32>
    %24 = "tosa.clamp"(%arg1) <{max_val = 32 : ui32, min_val = 4 : ui32, nan_mode = "PROPAGATE"}> : (tensor<1xui32>) -> tensor<1xui32>
