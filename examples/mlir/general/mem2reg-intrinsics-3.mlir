"builtin.module"() ({
  "llvm.func"() <{CConv = #llvm.cconv<ccc>, function_type = !llvm.func<i32 ()>, linkage = #llvm.linkage<external>, sym_name = "basic_memset_constant", unnamed_addr = 0 : i64, visibility_ = 0 : i64}> ({
