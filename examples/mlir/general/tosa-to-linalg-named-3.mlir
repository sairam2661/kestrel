"builtin.module"() ({
  ...
  ^bb0(%arg0: tensor<1x5x3xf32>, %arg1: tensor<1x3x?xf32>):
    ...
    %2 = "tosa.matmul"(%arg0, %arg1, %0, %1) : (tensor<1x5x3xf32>, tensor<1x3x?xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x5x?xf32>
    "func.return"(%2) : (tensor<1x5x?xf32>) -> ()
  }) : () -> ()
}) : () -> ()
