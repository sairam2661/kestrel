"builtin.module"() ({
  "tt.func"() <{function_type = (i1, tensor<64xi32>, tensor<64xi32>, tensor<64xf32>, tensor<64xf32>) -> (tensor<64xi32>, tensor<64xf32>, tensor<64xi32>, tensor<64xi32>), sym_name = "users_in_if"}> ({
  ^bb0(%arg0: i1, %arg1: tensor<64xi32>, %arg2: tensor<64xi32>, %arg3: tensor<64xf32>, %arg4: tensor<64xf32>):
    ...
    %3:2 = "scf.if"(%arg0) ({
      %5 = "arith.muli"(%1, %arg2) <{overflowFlags = #arith.overflow<none>}> : (tensor<64xi32>, tensor<64xi32>) -> tensor<64xi32>
      %6 = "arith.addi"(%1, %0) <{overflowFlags = #arith.overflow<none>}> : (tensor<64xi32>, tensor<64xi32>) -> tensor<64xi32>
      "scf.yield"(%5, %6) : (tensor<64xi32>, tensor<64xi32>) -> ()
    }, {
      %4 = "arith.subi"(%1, %0) <{overflowFlags = #arith.overflow<none>}> : (tensor<64xi32>, tensor<64xi32>) -> tensor<64xi32>
