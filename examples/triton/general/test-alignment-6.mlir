"builtin.module"() ({
  "tt.func"() <{function_type = () -> (), sym_name = "rem"}> ({
    ...
    %9 = "arith.constant"() <{value = dense<192> : tensor<128xi32>}> : () -> tensor<128xi32>
    %10 = "arith.remsi"(%0, %9) : (tensor<128xi32>, tensor<128xi32>) -> tensor<128xi32>
    %11 = "arith.remsi"(%9, %0) : (tensor<128xi32>, tensor<128xi32>) -> tensor<128xi32>
    %12 = "tt.make_range"() <{end = 160 : i32, start = 32 : i32}> : () -> tensor<128xi32>
    %13 = "arith.remsi"(%0, %12) : (tensor<128xi32>, tensor<128xi32>) -> tensor<128xi32>
    %14 = "arith.remsi"(%12, %0) : (tensor<128xi32>, tensor<128xi32>) -> tensor<128xi32>
    %15 = "arith.remsi"(%12, %4) : (tensor<128xi32>, tensor<128xi32>) -> tensor<128xi32>
    %16 = "arith.remsi"(%4, %12) : (tensor<128xi32>, tensor<128xi32>) -> tensor<128xi32>
    "tt.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
