...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<2x2xf32>, %arg1: memref<2x2xf32>):
    ...
    "affine.parallel"() <{lowerBoundsGroups = dense<1> : tensor<1xi32>, lowerBoundsMap = #map, reductions = [], steps = [1], upperBoundsGroups = dense<1> : tensor<1xi32>, upperBoundsMap = #map1}> ({
    ^bb0(%arg2: index):
