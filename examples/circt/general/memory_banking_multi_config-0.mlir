...
#map3 = affine_map<() -> (8)>
"builtin.module"() ({
  "func.func"() <{arg_attrs = [{banking.dimensions = [0, 1], banking.factors = [2, 3]}, {}], function_type = (memref<8x6xf32>, memref<8x6xf32>) -> memref<8x6xf32>, sym_name = "multi_config"}> ({
  ^bb0(%arg0: memref<8x6xf32>, %arg1: memref<8x6xf32>):
    %0 = "memref.alloc"() <{operandSegmentSizes = array<i32: 0, 0>}> {banking.dimensions = [0, 1], banking.factors = [4, 2]} : () -> memref<8x6xf32>
